...
pub fn keccak_special5_over_unrolled_state<
    M: MemorySource,
    TR: Tracer<C>,
    C: MachineConfig,
>(
    ...
    let mut state_accesses: [RegisterOrIndirectReadWriteData; X11_NUM_WRITES] = register_indirect_read_write_sparse_noexcept::<_, X11_NUM_WRITES>(x11 as usize, state_indexes_u32, memory_source);
