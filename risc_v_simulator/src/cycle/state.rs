                        ...
                        if Config::SUPPORT_STANDARD_CSRS == false {
                            ...
                            match csr_number {
                                ...
                                csr => {
                                    ...
                                    csr_processor.process_read(&mut self.observable.registers, memory_source, non_determinism_source, tracer,  csr_number, rs1, &mut ret_val, &mut trap);
                                    if trap.is_a_trap() {
                                        break 'cycle_block;
                                    }
                                }
                            ...
                            match csr_number {
                                ...
                                csr => {
                                    ...
                                    csr_processor.process_write(&mut self.observable.registers, memory_source, non_determinism_source, tracer,  csr_number, rs1,  &mut trap);
                                    if trap.is_a_trap() {
                                        break 'cycle_block;
                                    }
                                }
