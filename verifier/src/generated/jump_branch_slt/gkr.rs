    ...
    }
    {
        ...
        for j in 0..2 {
            let val = {
                ...
                {
                    const CK_LIN_GROUPS: [(usize, usize, usize); 22usize] = [
                        (0usize, 0usize, 1usize),
                        (1usize, 1usize, 2usize),
                        (3usize, 3usize, 1usize),
                        (4usize, 4usize, 3usize),
                        (7usize, 7usize, 1usize),
                        (8usize, 8usize, 1usize),
                        (9usize, 9usize, 2usize),
                        (10usize, 11usize, 2usize),
                        (11usize, 13usize, 2usize),
                        (12usize, 15usize, 4usize),
                        ...
                        (19usize, 25usize, 1usize),
                        (20usize, 26usize, 1usize),
                        (21usize, 27usize, 1usize),
                        (22usize, 28usize, 1usize),
                        (23usize, 29usize, 1usize),
                        (24usize, 30usize, 1usize),
                    ];
                    const CK_LIN_TERMS: [(u32, usize); 31usize] = [
                        ...
                        (1761599489u32, 34usize),
                        (251666432u32, 37usize),
                        (2013257729u32, 34usize),
                ...
                {
                    const CK_QUAD_GROUPS: [(usize, usize, usize); 24usize] = [
                        (0usize, 0usize, 1usize),
                        (1usize, 1usize, 15usize),
                        (2usize, 16usize, 19usize),
                        (3usize, 35usize, 1usize),
                        (4usize, 36usize, 15usize),
                        (5usize, 51usize, 19usize),
                        (6usize, 70usize, 3usize),
                        (7usize, 73usize, 3usize),
                        (8usize, 76usize, 2usize),
                        (9usize, 78usize, 1usize),
                        (10usize, 79usize, 1usize),
                        (11usize, 80usize, 3usize),
                        (13usize, 83usize, 1usize),
                        (14usize, 84usize, 1usize),
                        (15usize, 85usize, 1usize),
                        (16usize, 86usize, 1usize),
                        (17usize, 87usize, 1usize),
                        (18usize, 88usize, 1usize),
                        (19usize, 89usize, 1usize),
                        (20usize, 90usize, 1usize),
                        (21usize, 91usize, 1usize),
                        (22usize, 92usize, 1usize),
                        (23usize, 93usize, 1usize),
                        (24usize, 94usize, 1usize),
                    ];
                    const CK_QUAD_TERMS: [(u32, usize, usize); 95usize] = [
                        (268435454u32, 31usize, 31usize),
                        (268435454u32, 0usize, 4usize),
                        (1744830467u32, 2usize, 7usize),
                        (1744970275u32, 2usize, 10usize),
                        (1744830467u32, 3usize, 7usize),
                        (1744970275u32, 3usize, 10usize),
                        (268435454u32, 4usize, 7usize),
                        (1744970275u32, 4usize, 10usize),
                        (1744830467u32, 4usize, 25usize),
                        (268435454u32, 4usize, 27usize),
                        (268435454u32, 5usize, 7usize),
                        (1744970275u32, 5usize, 10usize),
                        (1744830467u32, 5usize, 25usize),
                        (268435454u32, 5usize, 27usize),
                        (268435454u32, 32usize, 2usize),
                        (268435454u32, 32usize, 3usize),
                        (268435454u32, 1usize, 4usize),
                        (1744830467u32, 2usize, 8usize),
                        (268435454u32, 2usize, 10usize),
                        (1744970275u32, 2usize, 11usize),
                        (1744830467u32, 3usize, 8usize),
                        (268435454u32, 3usize, 10usize),
                        (1744970275u32, 3usize, 11usize),
                        (268435454u32, 4usize, 8usize),
                        (268435454u32, 4usize, 10usize),
                        (1744970275u32, 4usize, 11usize),
                        (1744830467u32, 4usize, 26usize),
                        (268435454u32, 4usize, 28usize),
                        (268435454u32, 5usize, 8usize),
                        (268435454u32, 5usize, 10usize),
                        (1744970275u32, 5usize, 11usize),
                        (1744830467u32, 5usize, 26usize),
                        (268435454u32, 5usize, 28usize),
                        (268435454u32, 33usize, 2usize),
                        (268435454u32, 33usize, 3usize),
                        (268435454u32, 5usize, 14usize),
                        (268435454u32, 0usize, 2usize),
                        (268435454u32, 0usize, 3usize),
                        (268435454u32, 0usize, 15usize),
                        (1744830467u32, 2usize, 9usize),
                        (1744970275u32, 2usize, 12usize),
                        (1744830467u32, 3usize, 9usize),
                        (1744970275u32, 3usize, 12usize),
                        (268435454u32, 3usize, 25usize),
                        (1744830467u32, 4usize, 9usize),
                        (1744970275u32, 4usize, 12usize),
                        (1744830467u32, 5usize, 9usize),
                        (1744970275u32, 5usize, 12usize),
                        (268435454u32, 32usize, 2usize),
                        (268435454u32, 32usize, 4usize),
                        (268435454u32, 32usize, 5usize),
                        (268435454u32, 1usize, 2usize),
                        (268435454u32, 1usize, 3usize),
                        (268435454u32, 1usize, 15usize),
                        (268435454u32, 2usize, 12usize),
                        (1744970275u32, 2usize, 13usize),
                        (1744830467u32, 2usize, 36usize),
                        (268435454u32, 3usize, 12usize),
                        (1744970275u32, 3usize, 13usize),
                        (268435454u32, 3usize, 26usize),
                        (1744830467u32, 3usize, 36usize),
                        (268435454u32, 4usize, 12usize),
                        (1744970275u32, 4usize, 13usize),
                        (1744830467u32, 4usize, 36usize),
                        (268435454u32, 5usize, 12usize),
                        (1744970275u32, 5usize, 13usize),
                        (1744830467u32, 5usize, 36usize),
                        (268435454u32, 33usize, 2usize),
                        (268435454u32, 33usize, 4usize),
                        (268435454u32, 33usize, 5usize),
                        (268435454u32, 2usize, 16usize),
                        (268435454u32, 3usize, 16usize),
                        (268435454u32, 15usize, 16usize),
                        (268435454u32, 2usize, 7usize),
                        (268435454u32, 3usize, 7usize),
                        (268435454u32, 4usize, 14usize),
                        (268435454u32, 2usize, 8usize),
                        (268435454u32, 3usize, 8usize),
                        (1744830467u32, 6usize, 17usize),
                        (1744830467u32, 6usize, 18usize),
                        (1981808641u32, 34usize, 34usize),
                        (62914560u32, 34usize, 37usize),
                        (1981808641u32, 37usize, 37usize),
                        ...
                        (268435454u32, 19usize, 19usize),
                        (268435454u32, 20usize, 20usize),
                        (268435454u32, 21usize, 21usize),
                    ];
                    let mut _g: usize = 0;
                    while _g < 24usize {
...
> {
    unsafe {
        ...
        }
        {
            ...
            {
                let evals: &[[BabyBearExt4; 2]] = eval_buf.data_as(61usize);
            ...
            *state.prev_point.get_unchecked_mut(fc_len) = last_r;
            fc_len += 1;
            const EXTRA_COMMIT_BUF: usize = 112usize;
            let mut extra_buf = CommitBuf::<EXTRA_COMMIT_BUF>::new();
            let extra_data_words = 25usize * EXT_DEGREE;
            {
                let mut i = 0;
            ...
            {
                let slice: &[BabyBearExt4] = unsafe { extra_buf.data_as(25usize) };
                for el in slice {
                    extra_evals.push(*el);
                }
            }
            extra_buf.commit(&mut hasher, &mut seed, extra_data_words);
            let final_step_evals: &[[BabyBearExt4; 2]] = unsafe { eval_buf.data_as(61usize) };
            state.prev_claims.clear();
            {
