...
pub const GKR_TRANSCRIPT_U32: usize = 412usize;
pub const GKR_MAX_POW: usize = 25usize;
...
pub const NUM_BASE_CLAIMS: usize = 41usize;
pub const NUM_MEMORY_CLAIMS: usize = 14usize;
pub const NUM_WITNESS_CLAIMS: usize = 25usize;
...
pub const NUM_WIT_ORACLE_COLS: usize = 28usize;
pub const NUM_SETUP_ORACLE_COLS: usize = 12usize;
pub const TOTAL_ORACLE_COLS: usize = 66usize;
