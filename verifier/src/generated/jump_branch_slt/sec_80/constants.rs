...
pub const GKR_ADDRS: usize = 87usize;
...
pub const GKR_EVAL_BUF: usize = {
    let dim_reducing = 87usize * DIM_REDUCE_EVAL_POINTS * EXT_DEGREE;
    let standard = 87usize * STANDARD_EVAL_POINTS * EXT_DEGREE;
...
pub const ORACLE_NUM_COLS: [usize; 3usize] = [26usize, 29usize, 10usize];
pub const ORACLE_DEPTHS: [usize; 3usize] = [20usize, 20usize, 20usize];
pub const TOTAL_ORACLE_COLS: usize = 65usize;
