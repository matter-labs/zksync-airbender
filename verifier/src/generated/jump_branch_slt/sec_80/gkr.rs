...
unsafe fn layer_0_compute_claim(
    ...
    const DESCS: [(usize, usize, usize); 42usize] = [
...
unsafe fn layer_0_final_step_accumulator(
    ...
    let mut current_batch = BabyBearExt4::ONE;
    {
        const SIMPLE_GATES: [(SimpleGateType, [usize; 4]); 16usize] = [
            ...
            (
                ...
                [7usize, 23usize, 40usize, 0usize],
            ),
            (
                SimpleGateType::LookupInitialPair,
                [8usize, 34usize, 0usize, 0usize],
            ),
            (SimpleGateType::Copy, [9usize, 0usize, 0usize, 0usize]),
            (
                SimpleGateType::LookupWithSetup,
                [38usize, 24usize, 41usize, 0usize],
            ),
            (
                SimpleGateType::LookupInitialPair,
                [39usize, 50usize, 0usize, 0usize],
            ),
            (
                SimpleGateType::LookupInitialPair,
                [51usize, 52usize, 0usize, 0usize],
            ),
            (
                SimpleGateType::LookupInitialPair,
            ...
            (
                ...
                [32usize, 56usize, 25usize, 57usize],
            ),
            (
                SimpleGateType::LookupInitialPair,
    ...
    }
    {
        ...
        for j in 0..1 {
            ...
            const VAL_LN: [(usize, usize); 2usize] =
                [(2usize, 1073741816usize), (3usize, 1073741816usize)];
            let val =
                super::common::eval_max_quadratic(evals, &VAL_QO, &VAL_QI, &VAL_LN, 0usize, j);
            let mut contrib = bc;
            field_ops::mul_assign(&mut contrib, &val);
    ...
    }
    {
        ...
        for j in 0..1 {
            ...
            const VAL_QI: [(usize, usize); 1usize] = [(4usize, 1744830467usize)];
            const VAL_LN: [(usize, usize); 2usize] =
                [(14usize, 268435454usize), (29usize, 1744830467usize)];
            let val =
                super::common::eval_max_quadratic(evals, &VAL_QO, &VAL_QI, &VAL_LN, 0usize, j);
            let mut contrib = bc;
            field_ops::mul_assign(&mut contrib, &val);
    ...
    }
    {
        ...
        for j in 0..1 {
            const VAL_QO: [(usize, usize); 3usize] =
                [(2usize, 1usize), (3usize, 1usize), (16usize, 1usize)];
    ...
    }
    {
        ...
        for j in 0..1 {
            const VAL_QO: [(usize, usize); 3usize] =
                [(2usize, 1usize), (3usize, 1usize), (4usize, 1usize)];
            const VAL_QI: [(usize, usize); 3usize] = [
                (7usize, 268435454usize),
                (7usize, 268435454usize),
    ...
    }
    {
        ...
        for j in 0..1 {
            ...
            const VAL_QI: [(usize, usize); 2usize] =
                [(8usize, 268435454usize), (8usize, 268435454usize)];
    ...
    }
    {
        ...
        for j in 0..1 {
            ...
            const VAL_QI: [(usize, usize); 1usize] = [(18usize, 1744830467usize)];
            const VAL_LN: [(usize, usize); 2usize] =
                [(18usize, 268435454usize), (30usize, 1744830467usize)];
            let val =
                super::common::eval_max_quadratic(evals, &VAL_QO, &VAL_QI, &VAL_LN, 0usize, j);
            let mut contrib = bc;
            field_ops::mul_assign(&mut contrib, &val);
    ...
    }
    {
        ...
        for j in 0..1 {
            const VAL_QO: [(usize, usize); 1usize] = [(6usize, 1usize)];
            const VAL_QI: [(usize, usize); 1usize] = [(19usize, 1744830467usize)];
            const VAL_LN: [(usize, usize); 2usize] =
                [(19usize, 268435454usize), (31usize, 1744830467usize)];
            let val =
                super::common::eval_max_quadratic(evals, &VAL_QO, &VAL_QI, &VAL_LN, 0usize, j);
            let mut contrib = bc;
            field_ops::mul_assign(&mut contrib, &val);
    ...
    }
    {
        ...
        field_ops::mul_assign(&mut current_batch, &batch_base);
        for j in 0..1 {
            const VAL_QO: [(usize, usize); 2usize] = [(35usize, 2usize), (38usize, 1usize)];
            const VAL_QI: [(usize, usize); 3usize] = [
            ...
            const VAL_LN: [(usize, usize); 2usize] =
                [(35usize, 1761599489usize), (38usize, 251666432usize)];
...
unsafe fn layer_1_final_step_accumulator(
    ...
    let mut current_batch = BabyBearExt4::ONE;
    {
        const SIMPLE_GATES: [(SimpleGateType, [usize; 4]); 13usize] = [
            ...
            (
                SimpleGateType::LookupUnbalanced,
                [16usize, 17usize, 18usize, 0usize],
            ),
            (
                SimpleGateType::LookupAggregatePair,
...
fn check_virtual_setup_range_check_16bits<E: ErrorCreator>(
    ...
    unsafe {
        ...
        if result != *state.prev_claims.get_unchecked(65usize) {
...
fn check_virtual_setup_range_check_timestamp<E: ErrorCreator>(
    ...
    unsafe {
        ...
        if result != *state.prev_claims.get_unchecked(66usize) {
            return Err(E::gkr_virtual_setup_eval_mismatch(66usize));
        }
    }
    Ok(())
}
...
pub(crate) fn verify_gkr<I: NonDeterminismSource<BabyBearField>, E: ErrorCreator>(
    ...
    unsafe {
        ...
        }
        {
            ...
            let fc_len = 24usize;
            let data_words = 62usize * EXT_DEGREE;
            {
                let mut i = 0;
                while i < data_words {
                    eval_buf.data_write(i, read_reduced_field_el::<I>(nd_source).as_u32_raw_repr());
            ...
            {
                let evals: &[[BabyBearExt4; 1]] = eval_buf.data_as(62usize);
            ...
            {
                let slice: &[BabyBearExt4] = unsafe { eval_buf.data_as(62usize + 25usize) };
                let mut k = 62usize;
                while k < 62usize + 25usize {
                    extra_evals.push(unsafe { *slice.get_unchecked(k) });
                    k += 1;
                }
            }
            ts.commit(&mut eval_buf, data_words + 25usize * EXT_DEGREE);
            let next_batching = draw_single_field_el(ts);
            let final_step_evals: &[[BabyBearExt4; 1]] = unsafe { eval_buf.data_as(62usize) };
            state.prev_claims.clear();
            {
                const LAYOUT_KIND: [usize; 87usize] = [
                    ...
                    0usize, 0usize, 1usize, 0usize, 0usize, 0usize, 0usize, 0usize, 1usize, 0usize,
                ...
                const LAYOUT_POS: [usize; 87usize] = [
                    3usize, 4usize, 26usize, 27usize, 5usize, 6usize, 7usize, 28usize, 29usize,
                    8usize, 9usize, 10usize, 11usize, 12usize, 13usize, 30usize, 31usize, 32usize,
                    33usize, 34usize, 35usize, 36usize, 14usize, 37usize, 38usize, 39usize, 0usize,
                    1usize, 0usize, 2usize, 3usize, 4usize, 5usize, 6usize, 7usize, 8usize, 9usize,
                    10usize, 11usize, 12usize, 13usize, 1usize, 2usize, 14usize, 15usize, 16usize,
                    17usize, 18usize, 19usize, 20usize, 21usize, 22usize, 23usize, 24usize,
                    25usize, 15usize, 16usize, 17usize, 18usize, 19usize, 20usize, 21usize,
                    22usize, 23usize, 24usize, 40usize, 41usize, 42usize, 43usize, 44usize,
            ...
            }
            {
                const SC_DESCS: [(usize, u32, usize, usize); 6usize] = [
                    (75usize, 0u32, 0usize, 3usize),
                    (76usize, 133099247u32, 3usize, 3usize),
                    (77usize, 1744830467u32, 6usize, 3usize),
                    (78usize, 133099247u32, 9usize, 3usize),
                    (79usize, 1476395013u32, 12usize, 3usize),
                    (80usize, 133099247u32, 15usize, 3usize),
                ];
                const SC_TERMS: [(u32, usize); 18usize] = [
                    (1744830467u32, 20usize),
                    (268435454u32, 0usize),
                    (133099247u32, 49usize),
                    (1744830467u32, 21usize),
                    (268435454u32, 1usize),
                    (1744830467u32, 49usize),
                    (1744830467u32, 20usize),
                    (268435454u32, 5usize),
                    (133099247u32, 50usize),
                    (1744830467u32, 21usize),
                    (268435454u32, 6usize),
                    (1744830467u32, 50usize),
                    (1744830467u32, 20usize),
                    (268435454u32, 10usize),
                    (133099247u32, 51usize),
                    (1744830467u32, 21usize),
            ...
            }
            {
                const VL_DESCS: [(usize, usize, usize); 5usize] = [
                    (81usize, 0usize, 10usize),
                    (83usize, 10usize, 10usize),
                    (84usize, 20usize, 10usize),
                    (85usize, 30usize, 10usize),
                    (86usize, 40usize, 10usize),
                ];
                ...
                const VL_TERMS: [(u32, usize); 27usize] = [
                    ...
                    (536870908u32, 30usize),
                    (1073741816u32, 31usize),
                    (134217711u32, 32usize),
                    (268435422u32, 33usize),
                    (268435454u32, 34usize),
                    (268435454u32, 35usize),
                    (268435454u32, 41usize),
                    (268435454u32, 3usize),
                    (268435454u32, 42usize),
                    (133099247u32, 28usize),
                    (536591292u32, 38usize),
                    (1073182584u32, 41usize),
                    (268295646u32, 42usize),
            ...
            {
                const VS_DESCS: [(usize, usize, usize); 1usize] = [(82usize, 0usize, 10usize)];
            ...
            }
            {
                ...
                let cached = *state.prev_claims.get_unchecked(69usize);
                if expected != cached {
            ...
            }
            {
                ...
                let cached = *state.prev_claims.get_unchecked(70usize);
                if expected != cached {
            ...
            }
            {
                ...
                let cached = *state.prev_claims.get_unchecked(71usize);
                if expected != cached {
            ...
            }
            {
                ...
                let cached = *state.prev_claims.get_unchecked(72usize);
                if expected != cached {
            ...
            }
            {
                ...
                let cached = *state.prev_claims.get_unchecked(73usize);
                if expected != cached {
            ...
            }
            {
                ...
                let cached = *state.prev_claims.get_unchecked(74usize);
                if expected != cached {
