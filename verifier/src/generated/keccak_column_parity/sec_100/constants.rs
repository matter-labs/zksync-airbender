...
pub const GKR_ADDRS: usize = 276usize;
...
pub const GKR_EVAL_BUF: usize = {
    let dim_reducing = 276usize * DIM_REDUCE_EVAL_POINTS * EXT_DEGREE;
    let standard = 276usize * STANDARD_EVAL_POINTS * EXT_DEGREE;
...
pub const ORACLE_NUM_COLS: [usize; 3usize] = [91usize, 94usize, 8usize];
pub const ORACLE_DEPTHS: [usize; 3usize] = [18usize, 18usize, 18usize];
pub const TOTAL_ORACLE_COLS: usize = 193usize;
