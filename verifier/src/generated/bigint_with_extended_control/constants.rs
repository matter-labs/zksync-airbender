...
pub const GKR_MAX_POW: usize = 115usize;
...
pub const NUM_BASE_CLAIMS: usize = 217usize;
pub const NUM_MEMORY_CLAIMS: usize = 54usize;
pub const NUM_WITNESS_CLAIMS: usize = 161usize;
