...
pub fn verify_initial_whir_round<I: NonDeterminismSource<BabyBearField>, E: ErrorCreator>(
    ...
    unsafe {
        ...
        while q < INITIAL_NUM_QUERIES {
            ...
            process_oracle_query::<I, E, WHIR_HASH_BUF_SIZE, 194usize>(
                &mut ts.hasher,
                hash_buf,
                97usize,
                tree_index,
            ...
            process_oracle_query::<I, E, WHIR_HASH_BUF_SIZE, 322usize>(
                &mut ts.hasher,
                hash_buf,
                161usize,
                tree_index,
            ...
            process_oracle_query::<I, E, WHIR_HASH_BUF_SIZE, 6usize>(
                &mut ts.hasher,
                hash_buf,
                3usize,
                tree_index,
...
const INTERNAL_HASH_BUF_SIZE: usize = MAX_INTERNAL_LEAF_EXT_WORDS
    ...
    * BLAKE2S_BLOCK_SIZE_U32_WORDS;
const MAX_INTERNAL_NUM_QUERIES: usize = 15usize;
...
pub const WHIR_HASH_BUF_SIZE: usize = 336usize;
