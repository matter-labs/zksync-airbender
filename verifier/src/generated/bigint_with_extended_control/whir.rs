...
const MEM_LEAF_WORDS: usize = 194usize;
const WIT_LEAF_WORDS: usize = 322usize;
const SETUP_LEAF_WORDS: usize = 10usize;
const HASH_BUF_SIZE: usize = 336usize;
const FOLD_BUF_HALF: usize = 1usize;
const TOTAL_ORACLE_COLS_LOCAL: usize = 263usize;
