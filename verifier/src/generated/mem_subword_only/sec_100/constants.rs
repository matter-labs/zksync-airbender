...
pub const WHIR_QUERIES: [usize; 6usize] = [87usize, 24usize, 11usize, 8usize, 5usize, 5usize];
pub const WHIR_POW_BITS: [u32; 6usize] = [28u32, 20u32, 17u32, 10u32, 23u32, 23u32];
pub const LOOKUP_CHALLENGES_POW_BITS: u32 = 6u32;
pub const BATCHED_PROXIMITY_POW_BITS: u32 = 7u32;
pub const MAX_POW_ENTRIES: usize = 140usize;
