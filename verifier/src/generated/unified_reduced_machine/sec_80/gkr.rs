    ...
    unsafe {
        ...
        }
        {
            ...
            }
            {
                ...
                verify_final_step_check::<E>(f, final_eq_prefactor, final_claim, 4usize)?;
            }
            ts.commit(&mut eval_buf, data_words);
            let mut draw_buf = LazyVec::<BabyBearExt4, 2>::new();
            unsafe {
        ...
        }
        {
            ...
            let fc_len = 24usize;
            let data_words = 25usize * EXT_DEGREE;
            {
                let mut i = 0;
                while i < data_words {
                    eval_buf.data_write(i, read_reduced_field_el::<I>(nd_source).as_u32_raw_repr());
            ...
            {
                let evals: &[[BabyBearExt4; 1]] = eval_buf.data_as(25usize);
            ...
            state.prev_claims.clear();
            {
                ...
                while merged_idx < 77usize {
                    if ep_idx < 40usize && EXTRA_POS[ep_idx].0 == merged_idx {
                        ...
                        state
                            .prev_claims
                            .push(final_step_evals.get_unchecked(regular_idx)[0]);
                        regular_idx += 1;
                    }
                    merged_idx += 1;
                }
        ...
        }
        {
            ...
            let fc_len = 24usize;
            let data_words = 118usize * EXT_DEGREE;
            {
                let mut i = 0;
                while i < data_words {
                    eval_buf.data_write(i, read_reduced_field_el::<I>(nd_source).as_u32_raw_repr());
            ...
            {
                let evals: &[[BabyBearExt4; 1]] = eval_buf.data_as(118usize);
            ...
            ts.commit(&mut extra_buf, extra_data_words);
            let final_step_evals: &[[BabyBearExt4; 1]] = unsafe { eval_buf.data_as(118usize) };
            state.prev_claims.clear();
            {
