...
pub const GKR_ADDRS: usize = 144usize;
...
pub const GKR_EVAL_BUF: usize = {
    let dim_reducing = 144usize * DIM_REDUCE_EVAL_POINTS * EXT_DEGREE;
    let standard = 144usize * STANDARD_EVAL_POINTS * EXT_DEGREE;
...
pub const ORACLE_NUM_COLS: [usize; 3usize] = [42usize, 72usize, 10usize];
pub const ORACLE_DEPTHS: [usize; 3usize] = [20usize, 20usize, 20usize];
pub const TOTAL_ORACLE_COLS: usize = 124usize;
