...
const HASH_BUF_SIZE: usize = 160usize;
...
pub fn verify_initial_whir_round<I: NonDeterminismSource, E: ErrorCreator>(
    ...
    unsafe {
        ...
        while q < INITIAL_NUM_QUERIES {
            ...
            process_oracle_query::<I, E, WHIR_HASH_BUF_SIZE, 84usize>(
                &mut ts.hasher,
                hash_buf,
                42usize,
                tree_index,
            ...
            process_oracle_query::<I, E, WHIR_HASH_BUF_SIZE, 154usize>(
                &mut ts.hasher,
                hash_buf,
                77usize,
                tree_index,
...
pub const WHIR_HASH_BUF_SIZE: usize = 160usize;
