...
pub(crate) fn verify_gkr<I: NonDeterminismSource<BabyBearField>, E: ErrorCreator>(
    ...
    unsafe {
        ...
        }
        {
            ...
            let fc_len = 22usize;
            let data_words = 13usize * EXT_DEGREE;
            {
                let mut i = 0;
                while i < data_words {
                    eval_buf.data_write(i, read_reduced_field_el::<I>(nd_source).as_u32_raw_repr());
            ...
            {
                let evals: &[[BabyBearExt4; 1]] = eval_buf.data_as(13usize);
        ...
        }
        {
            ...
            let fc_len = 22usize;
            let data_words = 90usize * EXT_DEGREE;
            {
                let mut i = 0;
                while i < data_words {
                    eval_buf.data_write(i, read_reduced_field_el::<I>(nd_source).as_u32_raw_repr());
            ...
            {
                let evals: &[[BabyBearExt4; 1]] = eval_buf.data_as(90usize);
        ...
        }
        {
            ...
            let fc_len = 22usize;
            let data_words = 331usize * EXT_DEGREE;
            {
                let mut i = 0;
                while i < data_words {
                    eval_buf.data_write(i, read_reduced_field_el::<I>(nd_source).as_u32_raw_repr());
            ...
            {
                let evals: &[[BabyBearExt4; 1]] = eval_buf.data_as(331usize);
            ...
            {
                let slice: &[BabyBearExt4] = unsafe { eval_buf.data_as(331usize + 44usize) };
                let mut k = 331usize;
                while k < 331usize + 44usize {
                    extra_evals.push(unsafe { *slice.get_unchecked(k) });
                    k += 1;
                }
            }
            ts.commit(&mut eval_buf, data_words + 44usize * EXT_DEGREE);
            let next_batching = draw_single_field_el(ts);
            let final_step_evals: &[[BabyBearExt4; 1]] = unsafe { eval_buf.data_as(331usize) };
            state.prev_claims.clear();
            {
