...
pub const GKR_ADDRS: usize = 378usize;
...
pub const GKR_EVAL_BUF: usize = {
    let dim_reducing = 378usize * DIM_REDUCE_EVAL_POINTS * EXT_DEGREE;
    let standard = 378usize * STANDARD_EVAL_POINTS * EXT_DEGREE;
...
pub const TOTAL_ORACLE_COLS: usize = 275usize;
