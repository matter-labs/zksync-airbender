...
pub const WHIR_QUERIES: [usize; 5usize] = [87usize, 16usize, 9usize, 6usize, 5usize];
pub const WHIR_POW_BITS: [u32; 5usize] = [28u32, 20u32, 14u32, 20u32, 23u32];
pub const LOOKUP_CHALLENGES_POW_BITS: u32 = 4u32;
pub const BATCHED_PROXIMITY_POW_BITS: u32 = 5u32;
