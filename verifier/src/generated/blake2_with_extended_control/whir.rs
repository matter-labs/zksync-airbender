...
const MEM_LEAF_WORDS: usize = 450usize;
const WIT_LEAF_WORDS: usize = 1292usize;
const SETUP_LEAF_WORDS: usize = 12usize;
const HASH_BUF_SIZE: usize = 1296usize;
const FOLD_BUF_HALF: usize = 1usize;
const TOTAL_ORACLE_COLS_LOCAL: usize = 877usize;
...
pub fn verify_final_whir_round<I: NonDeterminismSource>(
    ...
    unsafe {
        ...
        let mut q = 0;
        while q < FINAL_NUM_QUERIES {
            let query_point = query_base_roots.get(q).pow(16u32);
