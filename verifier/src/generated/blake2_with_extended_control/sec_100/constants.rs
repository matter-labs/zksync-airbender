...
pub const TRACE_LEN_LOG2: u32 = 20u32;
pub const GKR_ADDRS: usize = 1262usize;
...
pub const GKR_EVAL_BUF: usize = {
    let dim_reducing = 1262usize * DIM_REDUCE_EVAL_POINTS * EXT_DEGREE;
    let standard = 1262usize * STANDARD_EVAL_POINTS * EXT_DEGREE;
...
pub const WHIR_QUERIES: [usize; 5usize] = [87usize, 11usize, 7usize, 6usize, 5usize];
pub const WHIR_POW_BITS: [u32; 5usize] = [28u32, 27u32, 25u32, 25u32, 21u32];
pub const LOOKUP_CHALLENGES_POW_BITS: u32 = 8u32;
pub const BATCHED_PROXIMITY_POW_BITS: u32 = 8u32;
pub const MAX_POW_ENTRIES: usize = 115usize;
pub const FINAL_MONOMIALS_LEN: usize = 2usize;
pub const NUM_ORACLES: usize = 3usize;
pub const ORACLE_NUM_COLS: [usize; 3usize] = [225usize, 647usize, 4usize];
pub const ORACLE_DEPTHS: [usize; 3usize] = [16usize, 16usize, 16usize];
pub const TOTAL_ORACLE_COLS: usize = 876usize;
pub const WHIR_ORACLE_DEPTHS: [usize; 4usize] = [18usize, 18usize, 16usize, 16usize];
