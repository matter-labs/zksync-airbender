...
pub const WHIR_QUERIES: [usize; 5usize] = [87usize, 12usize, 8usize, 6usize, 5usize];
pub const WHIR_POW_BITS: [u32; 5usize] = [28u32, 16u32, 15u32, 20u32, 23u32];
pub const LOOKUP_CHALLENGES_POW_BITS: u32 = 2u32;
pub const BATCHED_PROXIMITY_POW_BITS: u32 = 3u32;
