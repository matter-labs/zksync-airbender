    ...
    }
    {
        ...
        for j in 0..2 {
            ...
            }
            {
                ...
                let mut val_cv =
                    BabyBearExt4::from_base(BabyBearField::from_reduced_raw_repr(0u32));
                let mut val_t = unsafe { evals.get_unchecked(445usize) }[j];
                field_ops::mul_assign_by_base(
                    &mut val_t,
                    &BabyBearField::from_reduced_raw_repr(536870908u32),
                );
                field_ops::add_assign(&mut val_cv, &val_t);
                let mut val_t = unsafe { evals.get_unchecked(447usize) }[j];
                field_ops::mul_assign_by_base(
                    &mut val_t,
                    &BabyBearField::from_reduced_raw_repr(268435454u32),
                );
            ...
            }
            {
                ...
                let mut val_cv =
                    BabyBearExt4::from_base(BabyBearField::from_reduced_raw_repr(0u32));
                let mut val_t = unsafe { evals.get_unchecked(271usize) }[j];
                field_ops::mul_assign_by_base(
                    &mut val_t,
                    &BabyBearField::from_reduced_raw_repr(268435454u32),
                );
