...
pub(crate) fn verify_gkr<I: NonDeterminismSource, E: ErrorCreator>(
    ...
    unsafe {
        ...
        }
        {
            ...
            let data_words = 11usize * 2 * EXT_DEGREE;
            {
                let mut i = 0;
                while i < data_words {
                    eval_buf.data_write(i, read_reduced_field_el::<I>());
            ...
            {
                let evals: &[[BabyBearExt4; 2]] = eval_buf.data_as(11usize);
        ...
        }
        {
            ...
            let mut fc_len = 21usize;
            let data_words = 52usize * 2 * EXT_DEGREE;
            {
                let mut i = 0;
                while i < data_words {
                    eval_buf.data_write(i, read_reduced_field_el::<I>());
            ...
            {
                let evals: &[[BabyBearExt4; 2]] = eval_buf.data_as(52usize);
        ...
        }
        {
            ...
            let mut fc_len = 21usize;
            let data_words = 123usize * 2 * EXT_DEGREE;
            {
                let mut i = 0;
                while i < data_words {
                    eval_buf.data_write(i, read_reduced_field_el::<I>());
            ...
            {
                let evals: &[[BabyBearExt4; 2]] = eval_buf.data_as(123usize);
            ...
            *state.prev_point.get_unchecked_mut(fc_len) = last_r;
            ...
            let final_step_evals: &[[BabyBearExt4; 2]] = unsafe { eval_buf.data_as(123usize) };
            state.prev_claims.clear();
            {
                const EXTRA_POS: [(usize, usize); 57usize] = [
                    (4usize, 0usize),
                    (5usize, 1usize),
                    (6usize, 2usize),
                    (9usize, 3usize),
                ...
                while merged_idx < 180usize {
                    if ep_idx < 57usize && EXTRA_POS[ep_idx].0 == merged_idx {
                        state
                            .prev_claims
            ...
            }
            {
                ...
                const VL_TERMS: [(u32, usize); 136usize] = [
                    ...
                    (268435454u32, 7usize),
                    (16777216u32, 84usize),
                    (1996488705u32, 6usize),
                    (16777216u32, 63usize),
                    (16777216u32, 70usize),
                    (16777216u32, 95usize),
                    (1744831011u32, 0usize),
                    (1476396101u32, 1usize),
                    (1996488705u32, 4usize),
                    (268435454u32, 8usize),
                    (268435454u32, 9usize),
                    (268435454u32, 5usize),
                    (268435454u32, 10usize),
                    (16777216u32, 85usize),
                    (1996488705u32, 9usize),
                    (16777216u32, 64usize),
                    (16777216u32, 71usize),
                    (16777216u32, 96usize),
                    (16777216u32, 0usize),
                    (33554432u32, 1usize),
                    (1744831011u32, 2usize),
                    (1476396101u32, 3usize),
                    (1996488705u32, 5usize),
                    ...
                    (1048576u32, 70usize),
                    (2012217345u32, 18usize),
                    (2004877313u32, 19usize),
                    (1048576u32, 77usize),
                    (1048576u32, 10usize),
                    (268435456u32, 11usize),
                    (1744830499u32, 12usize),
                    (2012217345u32, 14usize),
                    (2004877313u32, 15usize),
                    ...
                    (1048576u32, 71usize),
                    (2012217345u32, 23usize),
                    (2004877313u32, 24usize),
                    (1048576u32, 78usize),
                    (1048576u32, 7usize),
                    (268435456u32, 8usize),
                    (1048576u32, 12usize),
                    (1744830499u32, 13usize),
                    (2012217345u32, 16usize),
                    (2004877313u32, 17usize),
                    ...
                    (1476396101u32, 1usize),
                    (16777216u32, 22usize),
                    (268435456u32, 25usize),
                    (134217727u32, 26usize),
                    (1744831011u32, 28usize),
                    (1476396101u32, 29usize),
                    (1996488705u32, 32usize),
                    ...
                    (1744831011u32, 2usize),
                    (1476396101u32, 3usize),
                    (268435456u32, 20usize),
                    (134217727u32, 21usize),
                    (16777216u32, 27usize),
                    (16777216u32, 28usize),
                    (33554432u32, 29usize),
                    (1744831011u32, 30usize),
                    (1476396101u32, 31usize),
                    (1996488705u32, 33usize),
                    (268435454u32, 37usize),
                    (268435454u32, 22usize),
                    (268435422u32, 25usize),
                    (268435454u32, 40usize),
                    (268435454u32, 42usize),
                    (268435454u32, 26usize),
                    (33554432u32, 77usize),
                    (33554432u32, 10usize),
                    (536870908u32, 11usize),
                    (1476396101u32, 12usize),
                    (33554432u32, 35usize),
                    (536870908u32, 36usize),
                    (1476396101u32, 38usize),
                    (1979711489u32, 40usize),
                    (268435454u32, 43usize),
                    (268435422u32, 20usize),
                    (268435454u32, 27usize),
                    ...
                    (536870908u32, 8usize),
                    (33554432u32, 12usize),
                    (1476396101u32, 13usize),
                    (536870908u32, 34usize),
                    (33554432u32, 37usize),
                    (33554432u32, 38usize),
                    (1476396101u32, 39usize),
                    (1979711489u32, 41usize),
