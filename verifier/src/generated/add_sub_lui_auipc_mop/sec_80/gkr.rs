    ...
    let mut current_batch = BabyBearExt4::ONE;
    {
        const SIMPLE_GATES: [(SimpleGateType, [usize; 4]); 15usize] = [
            ...
            (
                ...
                [11usize, 19usize, 41usize, 0usize],
            ),
            (
                SimpleGateType::LookupInitialPair,
                [12usize, 30usize, 0usize, 0usize],
            ),
            (
                SimpleGateType::LookupInitialPair,
                [31usize, 37usize, 0usize, 0usize],
            ),
            (SimpleGateType::Copy, [38usize, 0usize, 0usize, 0usize]),
            (
                SimpleGateType::LookupWithSetup,
                [39usize, 20usize, 42usize, 0usize],
            ),
            (
                SimpleGateType::LookupInitialPair,
                [40usize, 51usize, 0usize, 0usize],
            ),
            (
                SimpleGateType::LookupInitialPair,
            ...
            (
                ...
                [32usize, 57usize, 21usize, 58usize],
            ),
        ];
        let mut _sg = 0;
        while _sg < 15usize {
    ...
    }
    {
        ...
        for j in 0..1 {
            const VAL_QO: [(usize, usize); 3usize] =
                [(8usize, 2usize), (22usize, 2usize), (23usize, 2usize)];
    ...
    }
    {
        ...
        for j in 0..1 {
            ...
            const VAL_QI: [(usize, usize); 3usize] = [
                (33usize, 1usize),
                (37usize, 2013265919usize),
                (37usize, 1usize),
            ];
            const VAL_LN: [(usize, usize); 2usize] =
                [(33usize, 2013200393usize), (37usize, 65528usize)];
    ...
    }
    {
        ...
        for j in 0..1 {
            ...
            const VAL_QI: [(usize, usize); 3usize] = [
                ...
                (39usize, 62914560usize),
                (39usize, 1981808641usize),
            ];
            const VAL_LN: [(usize, usize); 2usize] =
                [(35usize, 1761599489usize), (39usize, 251666432usize)];
            let val = super::common::eval_max_quadratic(
                evals,
                &VAL_QO,
                &VAL_QI,
...
pub(crate) fn verify_gkr<I: NonDeterminismSource<BabyBearField>, E: ErrorCreator>(
    ...
    unsafe {
        ...
        }
        {
            ...
            let fc_len = 24usize;
            let data_words = 23usize * EXT_DEGREE;
            {
                let mut i = 0;
                while i < data_words {
                    eval_buf.data_write(i, read_reduced_field_el::<I>(nd_source).as_u32_raw_repr());
            ...
            {
                let evals: &[[BabyBearExt4; 1]] = eval_buf.data_as(23usize);
        ...
        }
        {
            ...
            let fc_len = 24usize;
            let data_words = 59usize * EXT_DEGREE;
            {
                let mut i = 0;
                while i < data_words {
                    eval_buf.data_write(i, read_reduced_field_el::<I>(nd_source).as_u32_raw_repr());
            ...
            {
                let evals: &[[BabyBearExt4; 1]] = eval_buf.data_as(59usize);
            ...
            {
                let slice: &[BabyBearExt4] = unsafe { eval_buf.data_as(59usize + 15usize) };
                let mut k = 59usize;
                while k < 59usize + 15usize {
            ...
            let next_batching = draw_single_field_el(ts);
            let final_step_evals: &[[BabyBearExt4; 1]] = unsafe { eval_buf.data_as(59usize) };
            state.prev_claims.clear();
            {
            ...
            }
            {
                ...
                const VL_TERMS: [(u32, usize); 16usize] = [
                    ...
                    (268435422u32, 32usize),
                    (536870844u32, 33usize),
                    (1073741688u32, 34usize),
                    (134217455u32, 35usize),
                    (268434910u32, 36usize),
                ];
                let mut _vl = 0;
                while _vl < 1usize {
