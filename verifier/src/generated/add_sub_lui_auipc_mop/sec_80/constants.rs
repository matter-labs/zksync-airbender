...
pub const GKR_ADDRS: usize = 77usize;
...
pub const GKR_EVAL_BUF: usize = {
    let dim_reducing = 77usize * DIM_REDUCE_EVAL_POINTS * EXT_DEGREE;
    let standard = 77usize * STANDARD_EVAL_POINTS * EXT_DEGREE;
...
pub const ORACLE_NUM_COLS: [usize; 3usize] = [30usize, 21usize, 8usize];
