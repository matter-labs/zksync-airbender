...
pub(crate) fn verify_gkr<I: NonDeterminismSource<BabyBearField>, E: ErrorCreator>(
    ...
    unsafe {
        ...
        }
        {
            ...
            {
                let slice: &[BabyBearExt4] = unsafe { extra_buf.data_as(22usize) };
                for el in slice {
                    extra_evals.push(*el);
                }
            }
