...
unsafe fn layer_0_final_step_accumulator(
    ...
    }
    {
        ...
        field_ops::mul_assign(&mut current_batch, &batch_base);
        for j in 0..1 {
            const VAL_QO: [(usize, usize); 2usize] = [(2usize, 1usize), (3usize, 1usize)];
            const VAL_QI: [(usize, usize); 2usize] =
                [(4usize, 268435454usize), (4usize, 268435454usize)];
    ...
    }
    {
        ...
        field_ops::mul_assign(&mut current_batch, &batch_base);
        for j in 0..1 {
            const VAL_QO: [(usize, usize); 2usize] = [(0usize, 1usize), (1usize, 1usize)];
            const VAL_QI: [(usize, usize); 2usize] =
                [(9usize, 268435454usize), (26usize, 268435454usize)];
            const VAL_LN: [(usize, usize); 0usize] = [];
            let val =
                super::common::eval_max_quadratic(evals, &VAL_QO, &VAL_QI, &VAL_LN, 0usize, j);
            let mut contrib = bc;
    ...
    }
    {
        ...
        for j in 0..1 {
            const VAL_QO: [(usize, usize); 2usize] = [(0usize, 1usize), (1usize, 1usize)];
            const VAL_QI: [(usize, usize); 2usize] =
                [(10usize, 268435454usize), (27usize, 268435454usize)];
            const VAL_LN: [(usize, usize); 0usize] = [];
            let val =
                super::common::eval_max_quadratic(evals, &VAL_QO, &VAL_QI, &VAL_LN, 0usize, j);
            let mut contrib = bc;
    ...
    }
    {
        ...
        for j in 0..1 {
            ...
            const VAL_LN: [(usize, usize); 2usize] =
                [(2usize, 268435454usize), (3usize, 268435454usize)];
            let val =
                super::common::eval_max_quadratic(evals, &VAL_QO, &VAL_QI, &VAL_LN, 0usize, j);
            let mut contrib = bc;
            field_ops::mul_assign(&mut contrib, &val);
    ...
    }
    {
        const SIMPLE_GATES: [(SimpleGateType, [usize; 4]); 23usize] = [
            ...
            (
                SimpleGateType::LookupWithSetup,
                [26usize, 19usize, 37usize, 0usize],
            ),
            (
                SimpleGateType::LookupInitialPair,
                [27usize, 9usize, 0usize, 0usize],
            ),
            (
                SimpleGateType::LookupInitialPair,
                [10usize, 11usize, 0usize, 0usize],
            ),
            (
                SimpleGateType::LookupInitialPair,
                [12usize, 33usize, 0usize, 0usize],
            ),
            (SimpleGateType::Copy, [34usize, 0usize, 0usize, 0usize]),
            (
                SimpleGateType::LookupWithSetup,
                [35usize, 20usize, 38usize, 0usize],
            ),
            (
                SimpleGateType::LookupInitialPair,
                [36usize, 47usize, 0usize, 0usize],
            ),
            (
                SimpleGateType::LookupInitialPair,
            ...
            (
                SimpleGateType::LookupInitialWithCachedDenominators,
                [28usize, 53usize, 21usize, 54usize],
            ),
            (
                SimpleGateType::LookupInitialPair,
            ...
            (
                SimpleGateType::LookupInitialPair,
                [57usize, 58usize, 0usize, 0usize],
            ),
            (
                SimpleGateType::LookupInitialPair,
                [59usize, 60usize, 0usize, 0usize],
            ),
        ];
        let mut _sg = 0;
        while _sg < 23usize {
    ...
    }
    {
        ...
        field_ops::mul_assign(&mut current_batch, &batch_base);
        for j in 0..1 {
            const VAL_QO: [(usize, usize); 2usize] = [(29usize, 2usize), (33usize, 1usize)];
            const VAL_QI: [(usize, usize); 3usize] = [
                (29usize, 1usize),
                (33usize, 2013265919usize),
                (33usize, 1usize),
            ];
            const VAL_LN: [(usize, usize); 2usize] =
                [(29usize, 2013200393usize), (33usize, 65528usize)];
    ...
    }
    {
        ...
        for j in 0..1 {
            ...
            const VAL_QI: [(usize, usize); 3usize] = [
                (31usize, 1981808641usize),
                (35usize, 62914560usize),
                (35usize, 1981808641usize),
            ];
            const VAL_LN: [(usize, usize); 2usize] =
                [(31usize, 1761599489usize), (35usize, 251666432usize)];
            let val = super::common::eval_max_quadratic(
                evals,
                &VAL_QO,
                &VAL_QI,
...
unsafe fn layer_1_final_step_accumulator(
    ...
    }
    {
        ...
        for j in 0..1 {
            const VAL_QO: [(usize, usize); 3usize] =
                [(10usize, 1usize), (14usize, 1usize), (19usize, 1usize)];
            const VAL_QI: [(usize, usize); 3usize] = [
    ...
    }
    {
        ...
        for j in 0..1 {
            const VAL_QO: [(usize, usize); 3usize] =
                [(11usize, 2usize), (15usize, 1usize), (20usize, 1usize)];
            const VAL_QI: [(usize, usize); 4usize] = [
                (15usize, 65536usize),
                (20usize, 2013200385usize),
                (22usize, 2013200385usize),
            ...
            const VAL_LN: [(usize, usize); 2usize] =
                [(9usize, 1744830467usize), (25usize, 268435454usize)];
            let val =
                super::common::eval_max_quadratic(evals, &VAL_QO, &VAL_QI, &VAL_LN, 0usize, j);
            let mut contrib = bc;
            field_ops::mul_assign(&mut contrib, &val);
    ...
    }
    {
        ...
        for j in 0..1 {
            const VAL_QO: [(usize, usize); 3usize] =
                [(12usize, 3usize), (14usize, 2usize), (17usize, 1usize)];
            const VAL_QI: [(usize, usize); 6usize] = [
                (12usize, 1usize),
                (14usize, 2013265919usize),
                (17usize, 2013265919usize),
                (14usize, 1usize),
                (17usize, 2usize),
                (17usize, 1usize),
            ];
    ...
    }
    {
        ...
        for j in 0..1 {
            ...
            const VAL_LN: [(usize, usize); 1usize] = [(16usize, 268295646usize)];
            let val =
                super::common::eval_max_quadratic(evals, &VAL_QO, &VAL_QI, &VAL_LN, 0usize, j);
            let mut contrib = bc;
            field_ops::mul_assign(&mut contrib, &val);
    ...
    }
    {
        ...
        for j in 0..1 {
            ...
            const VAL_QI: [(usize, usize); 2usize] =
                [(6usize, 268435454usize), (12usize, 1744830467usize)];
            const VAL_LN: [(usize, usize); 0usize] = [];
            let val =
                super::common::eval_max_quadratic(evals, &VAL_QO, &VAL_QI, &VAL_LN, 0usize, j);
            let mut contrib = bc;
    ...
    }
    {
        ...
        for j in 0..1 {
            const VAL_QO: [(usize, usize); 1usize] = [(5usize, 2usize)];
            const VAL_QI: [(usize, usize); 2usize] =
                [(7usize, 268435454usize), (13usize, 1744830467usize)];
            const VAL_LN: [(usize, usize); 0usize] = [];
            let val =
                super::common::eval_max_quadratic(evals, &VAL_QO, &VAL_QI, &VAL_LN, 0usize, j);
            let mut contrib = bc;
    ...
    }
    {
        ...
        for j in 0..1 {
            ...
            const VAL_QI: [(usize, usize); 1usize] = [(10usize, 1744830467usize)];
            const VAL_LN: [(usize, usize); 1usize] = [(5usize, 2013126113usize)];
            let val =
                super::common::eval_max_quadratic(evals, &VAL_QO, &VAL_QI, &VAL_LN, 0usize, j);
            let mut contrib = bc;
            field_ops::mul_assign(&mut contrib, &val);
    ...
    }
    {
        ...
        for j in 0..1 {
            const VAL_QO: [(usize, usize); 1usize] = [(5usize, 1usize)];
            const VAL_QI: [(usize, usize); 1usize] = [(11usize, 1744830467usize)];
            const VAL_LN: [(usize, usize); 1usize] = [(5usize, 2013126113usize)];
            let val =
                super::common::eval_max_quadratic(evals, &VAL_QO, &VAL_QI, &VAL_LN, 0usize, j);
            let mut contrib = bc;
...
pub(crate) fn verify_gkr<I: NonDeterminismSource<BabyBearField>, E: ErrorCreator>(
    ...
    unsafe {
        ...
        const DIM_REDUCE_INDICES_4: [usize; 8usize] = [
            6usize, 7usize, 0usize, 1usize, 2usize, 3usize, 4usize, 5usize,
        ];
        ...
        }
        {
            ...
            let fc_len = 24usize;
            let data_words = 14usize * EXT_DEGREE;
            {
                let mut i = 0;
                while i < data_words {
                    eval_buf.data_write(i, read_reduced_field_el::<I>(nd_source).as_u32_raw_repr());
            ...
            {
                let evals: &[[BabyBearExt4; 1]] = eval_buf.data_as(14usize);
        ...
        }
        {
            ...
            let fc_len = 24usize;
            let data_words = 21usize * EXT_DEGREE;
            {
                let mut i = 0;
                while i < data_words {
                    eval_buf.data_write(i, read_reduced_field_el::<I>(nd_source).as_u32_raw_repr());
            ...
            {
                let evals: &[[BabyBearExt4; 1]] = eval_buf.data_as(21usize);
        ...
        }
        {
            ...
            let fc_len = 24usize;
            let data_words = 54usize * EXT_DEGREE;
            {
                let mut i = 0;
                while i < data_words {
                    eval_buf.data_write(i, read_reduced_field_el::<I>(nd_source).as_u32_raw_repr());
            ...
            {
                let evals: &[[BabyBearExt4; 1]] = eval_buf.data_as(54usize);
            ...
            {
                const VL_DESCS: [(usize, usize, usize); 2usize] =
                    [(52usize, 0usize, 9usize), (53usize, 9usize, 9usize)];
                const VL_COLS: [(u32, usize, usize); 18usize] = [
                    (0u32, 0usize, 1usize),
                    (0u32, 1usize, 1usize),
                    (0u32, 2usize, 0usize),
                    (0u32, 2usize, 0usize),
        ...
        }
        {
            ...
            let fc_len = 24usize;
            let data_words = 61usize * EXT_DEGREE;
            {
                let mut i = 0;
                while i < data_words {
                    eval_buf.data_write(i, read_reduced_field_el::<I>(nd_source).as_u32_raw_repr());
            ...
            {
                let evals: &[[BabyBearExt4; 1]] = eval_buf.data_as(61usize);
            ...
            let mut extra_evals = LazyVec::<BabyBearExt4, 22usize>::new();
            {
                let slice: &[BabyBearExt4] = unsafe { eval_buf.data_as(61usize + 22usize) };
                let mut k = 61usize;
                while k < 61usize + 22usize {
                    extra_evals.push(unsafe { *slice.get_unchecked(k) });
                    k += 1;
                }
            }
            ts.commit(&mut eval_buf, data_words + 22usize * EXT_DEGREE);
            let next_batching = draw_single_field_el(ts);
            let final_step_evals: &[[BabyBearExt4; 1]] = unsafe { eval_buf.data_as(61usize) };
            state.prev_claims.clear();
            {
                const LAYOUT_KIND: [usize; 83usize] = [
                    1usize, 1usize, 0usize, 0usize, 1usize, 1usize, 1usize, 0usize, 0usize, 1usize,
                ...
                const LAYOUT_POS: [usize; 83usize] = [
                    2usize, 3usize, 22usize, 23usize, 4usize, 5usize, 6usize, 24usize, 25usize,
                    7usize, 8usize, 9usize, 10usize, 11usize, 12usize, 26usize, 27usize, 28usize,
                    29usize, 30usize, 31usize, 32usize, 33usize, 34usize, 35usize, 36usize, 0usize,
                    1usize, 0usize, 1usize, 2usize, 3usize, 4usize, 5usize, 6usize, 7usize, 8usize,
                    9usize, 10usize, 11usize, 12usize, 13usize, 14usize, 15usize, 16usize, 17usize,
                    18usize, 19usize, 20usize, 21usize, 13usize, 14usize, 15usize, 16usize,
                    17usize, 18usize, 19usize, 20usize, 21usize, 37usize, 38usize, 39usize,
                    40usize, 41usize, 42usize, 43usize, 44usize, 45usize, 46usize, 47usize,
                    48usize, 49usize, 50usize, 51usize, 52usize, 53usize, 54usize, 55usize,
                    56usize, 57usize, 58usize, 59usize, 60usize,
                ];
                let mut i = 0usize;
                while i < 83usize {
            ...
            {
                const VL_DESCS: [(usize, usize, usize); 7usize] = [
                    (75usize, 0usize, 9usize),
                    (77usize, 9usize, 9usize),
                    (78usize, 18usize, 9usize),
                    (79usize, 27usize, 9usize),
                    (80usize, 36usize, 9usize),
                    (81usize, 45usize, 9usize),
                    (82usize, 54usize, 9usize),
                ];
                const VL_COLS: [(u32, usize, usize); 63usize] = [
                    (0u32, 0usize, 1usize),
                    (0u32, 1usize, 1usize),
                    (0u32, 2usize, 1usize),
                    (0u32, 3usize, 1usize),
                    ...
                    (0u32, 21usize, 0usize),
                    (0u32, 21usize, 0usize),
                    (939524041u32, 21usize, 0usize),
                ];
                const VL_TERMS: [(u32, usize); 21usize] = [
                    ...
                    (536870908u32, 29usize),
                    (1073741816u32, 30usize),
                    (134217711u32, 31usize),
                    (268435454u32, 7usize),
                    (268435454u32, 8usize),
            ...
            {
                const VS_DESCS: [(usize, usize, usize); 1usize] = [(76usize, 0usize, 9usize)];
                const VS_DEPS: [usize; 9usize] = [
                    50usize, 51usize, 52usize, 53usize, 54usize, 55usize, 56usize, 57usize, 58usize,
                ];
                let mut _vs = 0;
                while _vs < 1usize {
            ...
            }
            {
                ...
                let mut t_addr: BabyBearExt4 =
                    external_challenges.permutation_argument_linearization_challenges[0usize];
                let addr_claim = *state.prev_claims.get_unchecked(9usize);
                field_ops::mul_assign(&mut t_addr, &addr_claim);
                field_ops::add_assign(&mut expected, &t_addr);
                {
                    let mut t_ts: BabyBearExt4 =
            ...
            }
            {
                ...
                field_ops::add_assign(&mut expected, &t_addr);
                {
                    let mut t_ts: BabyBearExt4 =
                        external_challenges.permutation_argument_linearization_challenges[2usize];
                    let mut ts_low = *state.prev_claims.get_unchecked(20usize);
                    field_ops::add_assign_base(
                        &mut ts_low,
                        &BabyBearField::from_reduced_raw_repr(0u32),
                    );
                ...
                }
                {
                    let mut t_ts: BabyBearExt4 =
                        external_challenges.permutation_argument_linearization_challenges[3usize];
                    let ts_high = *state.prev_claims.get_unchecked(21usize);
                    field_ops::mul_assign(&mut t_ts, &ts_high);
                    field_ops::add_assign(&mut expected, &t_ts);
                }
                {
            ...
            }
            {
                ...
                let mut t_addr: BabyBearExt4 =
                    external_challenges.permutation_argument_linearization_challenges[0usize];
                let addr_claim = *state.prev_claims.get_unchecked(14usize);
                field_ops::mul_assign(&mut t_addr, &addr_claim);
                field_ops::add_assign(&mut expected, &t_addr);
                {
                    let mut t_ts: BabyBearExt4 =
            ...
            }
            {
                ...
                let cached = *state.prev_claims.get_unchecked(67usize);
                if expected != cached {
            ...
            }
            {
                ...
                let cached = *state.prev_claims.get_unchecked(68usize);
                if expected != cached {
