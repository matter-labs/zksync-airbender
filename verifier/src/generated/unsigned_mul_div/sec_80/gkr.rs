...
pub(crate) fn verify_gkr<I: NonDeterminismSource, E: ErrorCreator>(
    ...
    unsafe {
        ...
        }
        {
            ...
            let mut fc_len = 23usize;
            let data_words = 21usize * 2 * EXT_DEGREE;
            {
                let mut i = 0;
                while i < data_words {
                    eval_buf.data_write(i, read_reduced_field_el::<I>(nd_source));
            ...
            {
                let evals: &[[BabyBearExt4; 2]] = eval_buf.data_as(21usize);
        ...
        }
        {
            ...
            let mut fc_len = 23usize;
            let data_words = 54usize * 2 * EXT_DEGREE;
            {
                let mut i = 0;
                while i < data_words {
                    eval_buf.data_write(i, read_reduced_field_el::<I>(nd_source));
            ...
            {
                let evals: &[[BabyBearExt4; 2]] = eval_buf.data_as(54usize);
        ...
        }
        {
            ...
            let mut fc_len = 23usize;
            let data_words = 61usize * 2 * EXT_DEGREE;
            {
                let mut i = 0;
                while i < data_words {
                    eval_buf.data_write(i, read_reduced_field_el::<I>(nd_source));
