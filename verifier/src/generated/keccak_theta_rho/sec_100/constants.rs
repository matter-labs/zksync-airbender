...
pub const GKR_ADDRS: usize = 404usize;
...
pub const GKR_EVAL_BUF: usize = {
    let dim_reducing = 404usize * DIM_REDUCE_EVAL_POINTS * EXT_DEGREE;
    let standard = 404usize * STANDARD_EVAL_POINTS * EXT_DEGREE;
...
pub const ORACLE_NUM_COLS: [usize; 3usize] = [104usize, 164usize, 9usize];
pub const ORACLE_DEPTHS: [usize; 3usize] = [18usize, 18usize, 18usize];
pub const TOTAL_ORACLE_COLS: usize = 277usize;
