...
use crate::forward::isa::{Instr, OperandLine, Program};
...
mod tests {
    use super::*;
    use crate::forward::context::CompiledLayer;
    use crate::forward::isa::{Instr, OperandLine, Program};
    ...
    use crate::forward::binding::{BackingKey, BackingTable};
    use crate::forward::context::{CompileTrace, DagForwardContext, OutputCell, RootOutput};
    ...
    fn compiled_with_one_descriptor_and_reference(desc: u16) -> CompiledLayer {
        ...
        let program = Program {
            instrs: vec![Instr::Add {
                field: crate::forward::isa::OperandField::Base,
                sign: crate::forward::isa::Sign::Plus,
                promote: false,
