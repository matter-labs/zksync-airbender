...
mod tests {
    use super::*;
    use crate::forward::binding::BackingTable;
    use crate::forward::context::{
        CompileTrace, CompiledLayer, DagForwardContext, OutputCell, RootOutput, RowOutputs,
    };
    use crate::forward::error::InterpError;
    use crate::forward::isa::*;
    use crate::forward::source::{ConstBank, SpecialTable};
    use crate::forward::stats::CompileStats;
    use gkr_eval_ir::{
    ...
    fn minimal_compiled(
        ...
        let ctx = DagForwardContext {
            ...
            derived_e4: crate::forward::source::DerivedE4Banks::default(),
            backings,
    ...
    fn promote_lifts_base_acc() {
        ...
        let backings = identity_base_mem_backings();
        let mut derived_e4 = crate::forward::source::DerivedE4Banks::default();
    ...
    fn compiled_mov_acc_from_special_desc0() -> (CompiledLayer, DagLayer) {
        use crate::forward::source::{SpecialDescriptor, SpecialStrategy};
        use gkr_eval_ir::ExprId;

        let mut specials = crate::forward::source::SpecialTable::default();
        ...
        let backings = identity_base_mem_backings();
        let ctx = crate::forward::context::DagForwardContext {
            specials,
            consts: crate::forward::source::ConstBank::default(),
            derived_e4: crate::forward::source::DerivedE4Banks::default(),
            backings,
            source_windows: Default::default(),
            actions: std::collections::HashMap::new(),
    ...
    fn with_peeks_uses_peek_resolver_for_special_operand() {
        ...
        use crate::forward::peek::{PeekError, PeekResolver};
        use crate::forward::source::SpecialDescriptor;
