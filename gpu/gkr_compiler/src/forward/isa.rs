...
mod tests {
    ...
    #[test]
    fn source_field_positions_pin_the_wire_format() {
        assert_eq!(FIRST_ACCESS_SHIFT, 2);
        assert_eq!(SOURCE_WINDOW_SHIFT, 3);
        assert_eq!(SOURCE_WINDOW_MASK, 0x3f);
        assert_eq!(SOURCE_COLUMN_SHIFT, 9);
        assert_eq!(SOURCE_COLUMN_MASK, 0x7f);
