...
//! the native shape mask, and the per-resource capacities the runtime binder
//! validates against.
...
pub const WINDOW_OPCODE_GROUP_BF: u16 = 6;
pub const WINDOW_OPCODE_GROUP_E4: u16 = 7;
pub const WINDOW_OPCODE_LINEAR_BF_PROCEDURAL: u16 = 4;
pub const WINDOW_OPCODE_PRODUCT_E4_E4: u16 = 5;
pub const WINDOW_OPCODE_PRODUCT_BF_BF_PROCEDURAL_B: u16 = 8;
pub const WINDOW_OPCODE_PRODUCT_BF_BF_PROCEDURAL_AB: u16 = 9;
pub const WINDOW_OPCODE_LINEAR_E4_WIDE: u16 = 10;
pub const WINDOW_FLAG_HAS_PRODUCT: u16 = 1 << 15;
pub const WINDOW_FLAG_REDUCE_AFTER: u16 = 1 << 15;
pub const WINDOW_FLAG_NEGATE_COEFFICIENT: u16 = 1 << 15;
...
pub struct WindowGroupedMember {
    pub term_class: u8,
    pub immediate: u32,
...
#[derive(Clone, Debug, PartialEq, Eq)]
pub struct WindowGroupedProgram {
    pub atoms: Vec<WindowGroupedAtom>,
...
/// Resource footprint the runtime binder validates against its own capacities.
...
pub fn window_source_slots(binding: &LeanSourceBinding) -> Vec<u16> {
    binding
        .source_slots
        .iter()
...
fn stored_slot(
    ...
    term: TermId,
    source: SourceId,
) -> Result<StoredSource, WindowLoweringError> {
    ...
    Ok(StoredSource::Slot(slot))
}

pub fn build_window_grouped_program(
    program: &R0LayerProgram,
    analysis: &CoeffGroupingAnalysis,
...
pub fn lower_window_sections(
    ...
    let lowered = WindowProgram {
        ...
        capacities: WindowCapacities {
            ...
            source_slots: program.source_slots.len(),
            windows: binding.windows.len(),
            immediates: immediates.len(),
            coefficient_plans: plans.len(),
        },
        words,
...
pub fn validate_window_coefficient_ids(program: &WindowProgram) -> Result<(), WindowLoweringError> {
