...
// `circuit_prover::prover::gkr::backward_flat_compact::GpuFlatRound0StaticDescCompact`.
...
EXTERN __device__ __constant__ e4 ab_gkr_flat_coefficients[airbender::gkr::FLAT_CONST_MAX];
...
template <typename E>
DEVICE_FORCEINLINE void flat_round0_compute_constant_compact(const flat_round0_static_desc_compact &desc, const E *__restrict__ eq_low,
                                                             const gkr_eq_sizes &eq_sizes, E *__restrict__ contributions, const unsigned acc_size,
                                                             const unsigned gid) {
