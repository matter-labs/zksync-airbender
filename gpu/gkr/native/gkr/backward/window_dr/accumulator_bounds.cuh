...
constexpr u32 DR_WINDOW_WIDE_MAX_WEIGHTINGS = GKR_DIM_REDUCING_SLOTS * GKR_DIM_REDUCING_OUTPUTS_PER_SLOT;
constexpr u32 DR_WINDOW_WIDE_MAX_PRODUCTS = 4 * DR_WINDOW_WIDE_MAX_WEIGHTINGS;
...
static_assert(DR_WINDOW_WIDE_MAX_PRODUCTS == 40, "DR wide accumulator bound assumes 40 products per coefficient");
