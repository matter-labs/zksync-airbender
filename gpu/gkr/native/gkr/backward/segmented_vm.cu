...
#define AB_GKR_BWD_SEG_KERNEL(symbol, desc_type, body, is_r0, epilogue, regq)                                                                                  \
  EXTERN __global__ void regq symbol(const __grid_constant__ airbender::gkr::desc_type desc) { airbender::gkr::body<is_r0, airbender::gkr::epilogue>(desc); }
...
#define AB_GKR_BWD_SEG_ACC_KERNEL(symbol, body, is_r0, regq)                                                                                                   \
  EXTERN __global__ void regq symbol(const __grid_constant__ airbender::gkr::bwd_seg_desc desc) { airbender::gkr::body<is_r0>(desc); }
