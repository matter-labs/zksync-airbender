...
fn count_metadata_terms<E>(
    src: &Option<crate::backward::kernels::GpuGKRMainLayerConstraintMetadataSource<E>>,
    filter_sentinel: bool,
) -> (usize, usize) {
    use crate::backward::kernels::GpuGKRMainLayerConstraintMetadataSource as MS;
...
pub(crate) fn project_layer_flat_round0_term_counts<E>(
    blueprints: &[crate::backward::kernels::GpuGKRMainLayerKernelBlueprint<E>],
) -> FlatRound0TermCounts {
    use crate::backward::kernels::GpuGKRMainLayerKernelKind as K;
    ...
    E: field::Field,
{
    use crate::backward::kernels::GpuGKRMainLayerConstraintMetadataSource as MS;
    use crate::backward::kernels::GpuGKRMainLayerKernelKind as K;
    use crate::immediate_factors::ImmediateFactorInterner;
