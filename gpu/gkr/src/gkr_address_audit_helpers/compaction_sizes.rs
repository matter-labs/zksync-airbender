...
use crate::backward::kernels::GKR_BACKWARD_MAX_KERNELS_PER_LAYER;
...
const TABLES_BYTES: usize = crate::backward::kernels::GKR_DIM_REDUCING_BASE_SLOTS * (8 + 4);
...
pub(crate) fn projected_post_compaction_sizes() -> PostCompactionSizes {
    ...
    let flat_continuation = align_up(
        TABLES_BYTES
            + crate::backward::kernels::GKR_DIM_REDUCING_BASE_SLOTS * 4 * 2 // prev_per_poly_offset[N], cache_per_poly_offset[N] (per-slot)
