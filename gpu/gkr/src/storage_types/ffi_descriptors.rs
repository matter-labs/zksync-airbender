...
#[repr(C)]
#[doc(hidden)]
pub struct GpuBaseFieldPolySource<B> {
    pub start: *const B,
    pub next_layer_size: usize,
    pub source_kind: GpuBaseFieldSourceKind,
}
...
#[repr(C)]
#[doc(hidden)]
pub struct GpuBaseFieldPolySourceAfterOneFoldingLaunchDescriptor<B, E> {
    pub base_layer_half_size: usize,
    pub next_layer_size: usize,
    pub base_input_start: *const B,
    pub this_layer_cache_start: *mut E,
...
#[repr(C)]
#[doc(hidden)]
pub struct GpuExtensionFieldPolyInitialSource<E> {
    pub start: *const E,
    pub next_layer_size: usize,
}
...
#[repr(C)]
#[doc(hidden)]
pub struct GpuExtensionFieldPolyContinuingLaunchDescriptor<E> {
    pub previous_layer_start: *const E,
    pub this_layer_start: *mut E,
    pub this_layer_size: usize,
    pub next_layer_size: usize,
    pub first_access: bool,
}
...
#[derive(Clone, Debug)]
#[doc(hidden)]
pub struct GpuSumcheckRound0LaunchDescriptors<B, E> {
    pub base_field_inputs: Vec<GpuBaseFieldPolySource<B>>,
    pub extension_field_inputs: Vec<GpuExtensionFieldPolyInitialSource<E>>,
    pub base_field_outputs: Vec<GpuBaseFieldPolySource<B>>,
    pub extension_field_outputs: Vec<GpuExtensionFieldPolyInitialSource<E>>,
}
