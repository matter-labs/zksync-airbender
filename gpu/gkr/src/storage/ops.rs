...
// Relocated out of `tests` to `storage_types` (cluster-C); re-exported at the
// crate root via the `storage_types::*` glob.
use super::super::{
...
#[cfg(test)]
use crate::{alloc_device_and_schedule_upload, alloc_host_and_schedule_copy};
