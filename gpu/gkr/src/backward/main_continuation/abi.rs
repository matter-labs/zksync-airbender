...
use crate::backward::window::common::{BwdSourceWindow, BWD_COEFF_NONE, BWD_SOURCE_LANE_NONE};
...
pub(crate) struct MainContinuationWindowDesc {
    ...
    pub(crate) slot: [BwdSourceWindow; MAIN_CONTINUATION_WINDOW_SOURCE_WINDOW_CAPACITY],
...
const _: () = {
    ...
    assert!(BWD_SOURCE_LANE_NONE == SOURCE_NONE);
