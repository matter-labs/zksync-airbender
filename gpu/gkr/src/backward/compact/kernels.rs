...
pub(crate) fn launch_main_round0<E: crate::BackwardKernels>(
    static_desc: &GpuFlatRound0StaticDesc,
...
pub(crate) fn launch_main_round0_constant<E: crate::BackwardKernels>(
    static_desc: &GpuFlatRound0StaticDesc,
    eq_low: *const E,
    eq_sizes: &GkrEqSizes,
    contributions: *mut E,
...
pub(crate) fn launch_main_round3_unified<E: crate::BackwardKernels>(
    desc: &GpuFlatContinuationUnifiedDesc,
    fold_stride: u32,
    next_layer_size: u32,
    folding_challenge_slot: u32,
...
pub(crate) fn launch_main_round3_unified_devptr<E: crate::BackwardKernels>(
    desc: &GpuFlatContinuationUnifiedDesc,
    fold_stride: u32,
    next_layer_size: u32,
    folding_challenge_slot: u32,
...
pub(crate) fn launch_main_round1_unified<E: crate::BackwardKernels>(
    desc: &GpuFlatRound1UnifiedDesc,
    fold_stride: u32,
    next_layer_size: u32,
    eq_low: *const E,
...
#[allow(clippy::too_many_arguments)]
pub(crate) fn launch_main_round1_unified_devptr<E: crate::BackwardKernels>(
    desc: &GpuFlatRound1UnifiedDesc,
    fold_stride: u32,
    next_layer_size: u32,
    coefficients: *const E,
...
pub(crate) fn launch_round2_challenges_prelude<E: crate::BackwardKernels>(
...
pub(crate) fn launch_main_round2_unified<E: crate::BackwardKernels>(
    desc: &GpuFlatRound2UnifiedDesc,
    folding_challenges: *const E,
    fold_stride: u32,
    next_layer_size: u32,
...
/// coefficients live.
#[allow(clippy::too_many_arguments)]
pub(crate) fn launch_main_round2_unified_devptr<E: crate::BackwardKernels>(
    desc: &GpuFlatRound2UnifiedDesc,
    folding_challenges: *const E,
    fold_stride: u32,
    next_layer_size: u32,
...
#[allow(clippy::too_many_arguments)]
pub(crate) fn launch_main_round1_unified_devptr_terms<E: crate::BackwardKernels>(
    desc: &GpuFlatRound1UnifiedDescDevptr,
    fold_stride: u32,
    next_layer_size: u32,
    coefficients: *const E,
...
#[allow(clippy::too_many_arguments)]
pub(crate) fn launch_main_round2_unified_devptr_terms<E: crate::BackwardKernels>(
    desc: &GpuFlatRound2UnifiedDescDevptr,
    folding_challenges: *const E,
    fold_stride: u32,
    next_layer_size: u32,
...
#[allow(clippy::too_many_arguments)]
pub(crate) fn launch_main_round3_unified_devptr_terms<E: crate::BackwardKernels>(
    desc: &GpuFlatContinuationUnifiedDescDevptr,
    fold_stride: u32,
    next_layer_size: u32,
    folding_challenge_slot: u32,
