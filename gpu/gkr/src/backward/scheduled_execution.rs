...
{
    pub fn shared_state_handle(&mut self) -> ScheduledBackwardWorkflowStateHandle<E> {
        gpu_core::primitives::context::UnsafeMutAccessor::new(self.shared_state.as_mut())
    }
    ...
    pub fn schedule_post_backward_handoff(
        &mut self,
    ...
    #[doc(hidden)]
    pub fn wait(self, context: &ProverContext) -> CudaResult<GpuGKRBackwardExecution<E>> {
...
where
    ...
    [(); E::DEGREE]: Sized,
{
    pub fn schedule_execute_backward_workflow_from_shared_state(
        mut self,
