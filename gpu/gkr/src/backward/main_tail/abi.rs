...
const _: () = {
    ...
    assert!(MAIN_TAIL_PROGRAM_WORD_CAPACITY == 8_192);
    assert!(MAIN_TAIL_PROGRAM_BYTES == 16_384);
    assert!(MAIN_TAIL_IMMEDIATE_OFFSET == 16_404);
    assert!(MAIN_TAIL_IMMEDIATE_CAPACITY == 512);
    assert!(MAIN_TAIL_BLOB_BYTES == 18_464);
