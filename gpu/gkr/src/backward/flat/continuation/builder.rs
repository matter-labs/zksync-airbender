...
pub(in crate::backward::flat) struct FlatContinuationDescriptionBuilder {
...
impl FlatContinuationDescriptionBuilder {
    pub(in crate::backward::flat) fn new() -> Self {
        Self {
    ...
    pub(in crate::backward::flat) fn push_constant(&mut self, recipe: CoefficientRecipe) {
    ...
    pub(in crate::backward::flat) fn push_c0_only_linear(
        &mut self,
        source_idx: u32,
    ...
    pub(in crate::backward::flat) fn push_unified_quadratic(
        &mut self,
        source_a: u32,
        source_b: u32,
        recipe: CoefficientRecipe,
    ...
    #[allow(dead_code)]
    pub(in crate::backward::flat) fn push_unified_linear(
        &mut self,
        source_idx: u32,
        recipe: CoefficientRecipe,
    ) {
    ...
    pub(in crate::backward::flat) fn finish(mut self) -> FlatContinuationBuildPlan {
