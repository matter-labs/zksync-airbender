...
impl<E: Copy> GpuGKRTranscriptHandoff<E> {
    ...
    pub fn final_explicit_evaluations(&self) -> BTreeMap<OutputType, [Vec<E>; 2]> {
    ...
    pub fn flattened_transcript_evaluations(&self) -> Vec<E> {
        let capacity = self
...
impl<B, E: Copy> GpuGKRForwardOutput<B, E> {
    ...
    pub fn schedule_transcript_handoff(
        &self,
...
impl<B, E> GpuGKRForwardOutput<B, E> {
    pub fn into_dimension_reducing_backward_state(
        self,
