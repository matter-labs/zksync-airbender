...
pub(in crate::forward) const FLAT_FWD_MAX_SOURCES: usize = 256;
pub(in crate::forward) const FLAT_FWD_MAX_PER_CATEGORY: usize = 16;

#[repr(C)]
#[derive(Debug, Default)]
pub(in crate::forward) struct GpuFlatFwdProductEntry<E> {
    pub(in crate::forward) src_a: u16,
    pub(in crate::forward) src_b: u16,
    pub(in crate::forward) dst: *mut E,
}
...
#[repr(C)]
#[derive(Debug, Default)]
pub(in crate::forward) struct GpuFlatFwdMaskEntry<E> {
    pub(in crate::forward) src_mask: u16,
    pub(in crate::forward) src_input: u16,
    pub(in crate::forward) dst: *mut E,
}
...
#[repr(C)]
#[derive(Debug, Default)]
pub(in crate::forward) struct GpuFlatFwdLookup4Entry<E> {
    pub(in crate::forward) src_a: u16,
    pub(in crate::forward) src_b: u16,
    pub(in crate::forward) src_c: u16,
    pub(in crate::forward) src_d: u16,
    pub(in crate::forward) num: *mut E,
    pub(in crate::forward) den: *mut E,
}
...
#[repr(C)]
#[derive(Debug, Default)]
pub(in crate::forward) struct GpuFlatFwdBfPairEntry<E> {
    pub(in crate::forward) src_b: u16,
    pub(in crate::forward) src_d: u16,
    pub(in crate::forward) num: *mut E,
    pub(in crate::forward) den: *mut E,
...
#[repr(C)]
#[derive(Debug, Default)]
pub(in crate::forward) struct GpuFlatFwdE4PairEntry<E> {
    pub(in crate::forward) src_b: u16,
    pub(in crate::forward) src_d: u16,
    pub(in crate::forward) num: *mut E,
    pub(in crate::forward) den: *mut E,
...
#[repr(C)]
#[derive(Debug, Default)]
pub(in crate::forward) struct GpuFlatFwdCachedDensEntry<E> {
    pub(in crate::forward) src_a: u16,
    pub(in crate::forward) src_b: u16,
    pub(in crate::forward) src_c: u16,
    pub(in crate::forward) src_d: u16,
...
#[repr(C)]
#[derive(Debug, Default)]
pub(in crate::forward) struct GpuFlatFwdBfMinusMultEntry<E> {
    pub(in crate::forward) src_b: u16,
    pub(in crate::forward) src_c: u16,
    pub(in crate::forward) src_d: u16,
    pub(in crate::forward) _pad: u16,
    pub(in crate::forward) num: *mut E,
    pub(in crate::forward) den: *mut E,
}
...
#[repr(C)]
#[derive(Debug, Default)]
pub(in crate::forward) struct GpuFlatFwdE4MinusMultEntry<E> {
    pub(in crate::forward) src_b: u16,
    pub(in crate::forward) src_c: u16,
    pub(in crate::forward) src_d: u16,
    pub(in crate::forward) _pad: u16,
...
#[repr(C)]
#[derive(Debug, Default)]
pub(in crate::forward) struct GpuFlatFwdBfUnbalancedEntry<E> {
    pub(in crate::forward) src_a: u16,
    pub(in crate::forward) src_b: u16,
    pub(in crate::forward) src_d: u16,
    pub(in crate::forward) _pad: u16,
...
#[repr(C)]
#[derive(Debug, Default)]
pub(in crate::forward) struct GpuFlatFwdE4UnbalancedEntry<E> {
    pub(in crate::forward) src_a: u16,
    pub(in crate::forward) src_b: u16,
    pub(in crate::forward) src_d: u16,
    pub(in crate::forward) _pad: u16,
...
#[repr(C)]
#[derive(Debug, Default)]
pub(in crate::forward) struct GpuFlatFwdMappedBfPairEntry<E> {
    pub(in crate::forward) mapping_b: *const u32,
    pub(in crate::forward) mapping_d: *const u32,
    pub(in crate::forward) num: *mut E,
    pub(in crate::forward) den: *mut E,
}
...
#[repr(C)]
#[derive(Debug, Default)]
pub(in crate::forward) struct GpuFlatFwdMappedE4PairEntry<E> {
    pub(in crate::forward) mapping_b: *const u32,
    pub(in crate::forward) mapping_d: *const u32,
    pub(in crate::forward) generic_lookup: *const E,
    pub(in crate::forward) num: *mut E,
    pub(in crate::forward) den: *mut E,
}
...
#[repr(C)]
#[derive(Debug, Default)]
pub(in crate::forward) struct GpuFlatFwdMappedCachedDensEntry<E> {
    pub(in crate::forward) mapping_b: *const u32,
    pub(in crate::forward) generic_lookup: *const E,
    pub(in crate::forward) decoder_mask: *const BF,
    pub(in crate::forward) decoder_fill_value: *const E,
    pub(in crate::forward) src_a: u16,
    pub(in crate::forward) src_c: u16,
    pub(in crate::forward) generic_lookup_len: u32,
    pub(in crate::forward) _pad: u32,
    pub(in crate::forward) num: *mut E,
    pub(in crate::forward) den: *mut E,
}
...
#[repr(C)]
#[derive(Debug, Default)]
pub(in crate::forward) struct GpuFlatFwdMappedE4MinusMultEntry<E> {
    pub(in crate::forward) mapping_b: *const u32,
    pub(in crate::forward) generic_lookup: *const E,
    pub(in crate::forward) src_c: u16,
    pub(in crate::forward) _pad: u16,
...
#[repr(C)]
#[derive(Debug, Default)]
pub(in crate::forward) struct GpuFlatFwdMappedE4UnbalancedEntry<E> {
    pub(in crate::forward) src_a: u16,
    pub(in crate::forward) src_b: u16,
    pub(in crate::forward) _pad: u32,
    pub(in crate::forward) mapping_d: *const u32,
...
#[repr(C)]
#[derive(Debug)]
pub(in crate::forward) struct GpuFlatFwdMemoryExpr<E> {
    pub(in crate::forward) address_space_kind: GpuGKRForwardCacheAddressSpaceKind,
    pub(in crate::forward) address_space_ptr: *const BF,
    pub(in crate::forward) address_space_constant: BF,
    pub(in crate::forward) constant_term: E,
    pub(in crate::forward) linear_inputs: [*const BF; MEMORY_TUPLE_LINEAR_TERMS],
    pub(in crate::forward) linear_challenges: [E; MEMORY_TUPLE_LINEAR_TERMS],
}
...
#[repr(C)]
#[derive(Debug)]
pub(in crate::forward) struct GpuFlatFwdMemoryProductEntry<E> {
    pub(in crate::forward) lhs: GpuFlatFwdMemoryExpr<E>,
    pub(in crate::forward) rhs: GpuFlatFwdMemoryExpr<E>,
    pub(in crate::forward) dst: *mut E,
}
...
#[repr(C)]
#[derive(Debug)]
pub(in crate::forward) struct GpuFlatFwdMemoryMaterializeEntry<E> {
    pub(in crate::forward) expr: GpuFlatFwdMemoryExpr<E>,
    pub(in crate::forward) dst: *mut E,
}
...
pub(crate) struct GpuFlatForwardStaticDesc<E> {
    pub(in crate::forward) sources: [*const u8; FLAT_FWD_MAX_SOURCES],
    pub(in crate::forward) num_sources: u32,

    pub(in crate::forward) products: [GpuFlatFwdProductEntry<E>; FLAT_FWD_MAX_PER_CATEGORY],
    pub(in crate::forward) num_products: u32,

    pub(in crate::forward) masks: [GpuFlatFwdMaskEntry<E>; FLAT_FWD_MAX_PER_CATEGORY],
    pub(in crate::forward) num_masks: u32,

    pub(in crate::forward) lookup4s: [GpuFlatFwdLookup4Entry<E>; FLAT_FWD_MAX_PER_CATEGORY],
    pub(in crate::forward) num_lookup4s: u32,

    pub(in crate::forward) bf_pairs: [GpuFlatFwdBfPairEntry<E>; FLAT_FWD_MAX_PER_CATEGORY],
    pub(in crate::forward) num_bf_pairs: u32,

    pub(in crate::forward) e4_pairs: [GpuFlatFwdE4PairEntry<E>; FLAT_FWD_MAX_PER_CATEGORY],
    pub(in crate::forward) num_e4_pairs: u32,

    pub(in crate::forward) cached_denses: [GpuFlatFwdCachedDensEntry<E>; FLAT_FWD_MAX_PER_CATEGORY],
    pub(in crate::forward) num_cached_denses: u32,

    pub(in crate::forward) bf_minus_mults:
        [GpuFlatFwdBfMinusMultEntry<E>; FLAT_FWD_MAX_PER_CATEGORY],
    pub(in crate::forward) num_bf_minus_mults: u32,

    pub(in crate::forward) e4_minus_mults:
        [GpuFlatFwdE4MinusMultEntry<E>; FLAT_FWD_MAX_PER_CATEGORY],
    pub(in crate::forward) num_e4_minus_mults: u32,

    pub(in crate::forward) bf_unbalanceds:
        [GpuFlatFwdBfUnbalancedEntry<E>; FLAT_FWD_MAX_PER_CATEGORY],
    pub(in crate::forward) num_bf_unbalanceds: u32,

    pub(in crate::forward) e4_unbalanceds:
        [GpuFlatFwdE4UnbalancedEntry<E>; FLAT_FWD_MAX_PER_CATEGORY],
    pub(in crate::forward) num_e4_unbalanceds: u32,

    pub(in crate::forward) mapped_bf_pairs:
        [GpuFlatFwdMappedBfPairEntry<E>; FLAT_FWD_MAX_PER_CATEGORY],
    pub(in crate::forward) num_mapped_bf_pairs: u32,

    pub(in crate::forward) mapped_e4_pairs:
        [GpuFlatFwdMappedE4PairEntry<E>; FLAT_FWD_MAX_PER_CATEGORY],
    pub(in crate::forward) num_mapped_e4_pairs: u32,

    pub(in crate::forward) mapped_cached_denses:
        [GpuFlatFwdMappedCachedDensEntry<E>; FLAT_FWD_MAX_PER_CATEGORY],
    pub(in crate::forward) num_mapped_cached_denses: u32,

    pub(in crate::forward) mapped_e4_minus_mults:
        [GpuFlatFwdMappedE4MinusMultEntry<E>; FLAT_FWD_MAX_PER_CATEGORY],
    pub(in crate::forward) num_mapped_e4_minus_mults: u32,

    pub(in crate::forward) mapped_e4_unbalanceds:
        [GpuFlatFwdMappedE4UnbalancedEntry<E>; FLAT_FWD_MAX_PER_CATEGORY],
    pub(in crate::forward) num_mapped_e4_unbalanceds: u32,

    pub(in crate::forward) memory_products:
        [GpuFlatFwdMemoryProductEntry<E>; FLAT_FWD_MAX_PER_CATEGORY],
    pub(in crate::forward) num_memory_products: u32,

    pub(in crate::forward) memory_materializes:
        [GpuFlatFwdMemoryMaterializeEntry<E>; FLAT_FWD_MAX_PER_CATEGORY],
    pub(in crate::forward) num_memory_materializes: u32,
}
...
pub(in crate::forward) fn launch_flat_forward_layer<E: crate::ForwardKernels>(
...
pub(in crate::forward) fn flat_desc_has_work<E>(desc: &GpuFlatForwardStaticDesc<E>) -> bool {
    desc.num_products
        | desc.num_masks
        | desc.num_lookup4s
        | desc.num_bf_pairs
