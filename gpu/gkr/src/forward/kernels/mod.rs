...
pub(crate) fn launch_forward_cache<E: crate::ForwardKernels>(
...
pub(crate) fn launch_virtual_base_accum<E: crate::ForwardKernels>(
    source_kind: GpuBaseFieldSourceKind,
    scalar: E,
    dst: *mut E,
    count: usize,
...
/// `crate::ForwardKernels` supertrait aggregates this with the
...
impl ForwardKernels for gpu_core::primitives::field::E4 {
