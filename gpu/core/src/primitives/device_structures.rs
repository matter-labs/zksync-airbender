...
mod sealed {
    pub trait DeviceBackingSealed {}
    pub trait DeviceBackingMutSealed {}
}

pub trait DeviceBacking<T>: sealed::DeviceBackingSealed {
    fn as_device_slice(&self) -> &DeviceSlice<T>;
}

pub trait DeviceBackingMut<T>: DeviceBacking<T> + sealed::DeviceBackingMutSealed {
