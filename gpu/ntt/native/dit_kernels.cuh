// Production NTT device templates: ntt_single (one engine call, no smem hop),
// ntt_single_stream, and ntt_two_pass. The bench-only fixed-loop variant
// (ntt_two_pass_fixed) lives in bench/dit_bench_kernels.cu.
#pragma once
