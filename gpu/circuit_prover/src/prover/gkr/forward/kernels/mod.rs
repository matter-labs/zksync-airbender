...
pub(crate) fn launch_forward_cache<E: crate::prover::gkr::ForwardKernels>(
...
pub(crate) fn launch_virtual_base_accum<E: crate::prover::gkr::ForwardKernels>(
    source_kind: GpuBaseFieldSourceKind,
    scalar: E,
    dst: *mut E,
    count: usize,
...
pub(crate) fn launch_dimension_reducing_forward_tower_lookup<
    E: crate::prover::gkr::ForwardKernels,
>(
...
/// Forward-phase GPU kernels. Defined and implemented in the leaf module that
/// owns the underlying `ab_*_e4_kernel` symbols (and the
...
impl ForwardKernels for crate::primitives::field::E4 {
