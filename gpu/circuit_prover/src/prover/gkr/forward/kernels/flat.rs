...
pub(in crate::prover::gkr::forward) const FLAT_FWD_MAX_SOURCES: usize = 256;
pub(in crate::prover::gkr::forward) const FLAT_FWD_MAX_PER_CATEGORY: usize = 16;

#[repr(C)]
#[derive(Debug, Default)]
pub(in crate::prover::gkr::forward) struct GpuFlatFwdProductEntry<E> {
    pub(in crate::prover::gkr::forward) src_a: u16,
    pub(in crate::prover::gkr::forward) src_b: u16,
    pub(in crate::prover::gkr::forward) dst: *mut E,
}
...
#[repr(C)]
#[derive(Debug, Default)]
pub(in crate::prover::gkr::forward) struct GpuFlatFwdMaskEntry<E> {
    pub(in crate::prover::gkr::forward) src_mask: u16,
    pub(in crate::prover::gkr::forward) src_input: u16,
    pub(in crate::prover::gkr::forward) dst: *mut E,
}
...
#[repr(C)]
#[derive(Debug, Default)]
pub(in crate::prover::gkr::forward) struct GpuFlatFwdLookup4Entry<E> {
    pub(in crate::prover::gkr::forward) src_a: u16,
    pub(in crate::prover::gkr::forward) src_b: u16,
    pub(in crate::prover::gkr::forward) src_c: u16,
    pub(in crate::prover::gkr::forward) src_d: u16,
    pub(in crate::prover::gkr::forward) num: *mut E,
    pub(in crate::prover::gkr::forward) den: *mut E,
}
...
#[repr(C)]
#[derive(Debug, Default)]
pub(in crate::prover::gkr::forward) struct GpuFlatFwdBfPairEntry<E> {
    pub(in crate::prover::gkr::forward) src_b: u16,
    pub(in crate::prover::gkr::forward) src_d: u16,
    pub(in crate::prover::gkr::forward) num: *mut E,
    pub(in crate::prover::gkr::forward) den: *mut E,
...
#[repr(C)]
#[derive(Debug, Default)]
pub(in crate::prover::gkr::forward) struct GpuFlatFwdE4PairEntry<E> {
    pub(in crate::prover::gkr::forward) src_b: u16,
    pub(in crate::prover::gkr::forward) src_d: u16,
    pub(in crate::prover::gkr::forward) num: *mut E,
    pub(in crate::prover::gkr::forward) den: *mut E,
...
#[repr(C)]
#[derive(Debug, Default)]
pub(in crate::prover::gkr::forward) struct GpuFlatFwdCachedDensEntry<E> {
    pub(in crate::prover::gkr::forward) src_a: u16,
    pub(in crate::prover::gkr::forward) src_b: u16,
    pub(in crate::prover::gkr::forward) src_c: u16,
    pub(in crate::prover::gkr::forward) src_d: u16,
...
#[repr(C)]
#[derive(Debug, Default)]
pub(in crate::prover::gkr::forward) struct GpuFlatFwdBfMinusMultEntry<E> {
    pub(in crate::prover::gkr::forward) src_b: u16,
    pub(in crate::prover::gkr::forward) src_c: u16,
    pub(in crate::prover::gkr::forward) src_d: u16,
    pub(in crate::prover::gkr::forward) _pad: u16,
    pub(in crate::prover::gkr::forward) num: *mut E,
    pub(in crate::prover::gkr::forward) den: *mut E,
}
...
#[repr(C)]
#[derive(Debug, Default)]
pub(in crate::prover::gkr::forward) struct GpuFlatFwdE4MinusMultEntry<E> {
    pub(in crate::prover::gkr::forward) src_b: u16,
    pub(in crate::prover::gkr::forward) src_c: u16,
    pub(in crate::prover::gkr::forward) src_d: u16,
    pub(in crate::prover::gkr::forward) _pad: u16,
...
#[repr(C)]
#[derive(Debug, Default)]
pub(in crate::prover::gkr::forward) struct GpuFlatFwdBfUnbalancedEntry<E> {
    pub(in crate::prover::gkr::forward) src_a: u16,
    pub(in crate::prover::gkr::forward) src_b: u16,
    pub(in crate::prover::gkr::forward) src_d: u16,
    pub(in crate::prover::gkr::forward) _pad: u16,
...
#[repr(C)]
#[derive(Debug, Default)]
pub(in crate::prover::gkr::forward) struct GpuFlatFwdE4UnbalancedEntry<E> {
    pub(in crate::prover::gkr::forward) src_a: u16,
    pub(in crate::prover::gkr::forward) src_b: u16,
    pub(in crate::prover::gkr::forward) src_d: u16,
    pub(in crate::prover::gkr::forward) _pad: u16,
...
#[repr(C)]
#[derive(Debug, Default)]
pub(in crate::prover::gkr::forward) struct GpuFlatFwdMappedBfPairEntry<E> {
    pub(in crate::prover::gkr::forward) mapping_b: *const u32,
    pub(in crate::prover::gkr::forward) mapping_d: *const u32,
    pub(in crate::prover::gkr::forward) num: *mut E,
    pub(in crate::prover::gkr::forward) den: *mut E,
}
...
#[repr(C)]
#[derive(Debug, Default)]
pub(in crate::prover::gkr::forward) struct GpuFlatFwdMappedE4PairEntry<E> {
    pub(in crate::prover::gkr::forward) mapping_b: *const u32,
    pub(in crate::prover::gkr::forward) mapping_d: *const u32,
    pub(in crate::prover::gkr::forward) generic_lookup: *const E,
    pub(in crate::prover::gkr::forward) num: *mut E,
    pub(in crate::prover::gkr::forward) den: *mut E,
}
...
#[repr(C)]
#[derive(Debug, Default)]
pub(in crate::prover::gkr::forward) struct GpuFlatFwdMappedCachedDensEntry<E> {
    pub(in crate::prover::gkr::forward) mapping_b: *const u32,
    pub(in crate::prover::gkr::forward) generic_lookup: *const E,
    pub(in crate::prover::gkr::forward) decoder_mask: *const BF,
    pub(in crate::prover::gkr::forward) decoder_fill_value: *const E,
    pub(in crate::prover::gkr::forward) src_a: u16,
    pub(in crate::prover::gkr::forward) src_c: u16,
    pub(in crate::prover::gkr::forward) generic_lookup_len: u32,
    pub(in crate::prover::gkr::forward) _pad: u32,
    pub(in crate::prover::gkr::forward) num: *mut E,
    pub(in crate::prover::gkr::forward) den: *mut E,
}
...
#[repr(C)]
#[derive(Debug, Default)]
pub(in crate::prover::gkr::forward) struct GpuFlatFwdMappedE4MinusMultEntry<E> {
    pub(in crate::prover::gkr::forward) mapping_b: *const u32,
    pub(in crate::prover::gkr::forward) generic_lookup: *const E,
    pub(in crate::prover::gkr::forward) src_c: u16,
    pub(in crate::prover::gkr::forward) _pad: u16,
...
#[repr(C)]
#[derive(Debug, Default)]
pub(in crate::prover::gkr::forward) struct GpuFlatFwdMappedE4UnbalancedEntry<E> {
    pub(in crate::prover::gkr::forward) src_a: u16,
    pub(in crate::prover::gkr::forward) src_b: u16,
    pub(in crate::prover::gkr::forward) _pad: u32,
    pub(in crate::prover::gkr::forward) mapping_d: *const u32,
...
#[repr(C)]
#[derive(Debug)]
pub(in crate::prover::gkr::forward) struct GpuFlatFwdMemoryExpr<E> {
    pub(in crate::prover::gkr::forward) address_space_kind: GpuGKRForwardCacheAddressSpaceKind,
    pub(in crate::prover::gkr::forward) address_space_ptr: *const BF,
    pub(in crate::prover::gkr::forward) address_space_constant: BF,
    pub(in crate::prover::gkr::forward) constant_term: E,
    pub(in crate::prover::gkr::forward) linear_inputs: [*const BF; MEMORY_TUPLE_LINEAR_TERMS],
    pub(in crate::prover::gkr::forward) linear_challenges: [E; MEMORY_TUPLE_LINEAR_TERMS],
}
...
#[repr(C)]
#[derive(Debug)]
pub(in crate::prover::gkr::forward) struct GpuFlatFwdMemoryProductEntry<E> {
    pub(in crate::prover::gkr::forward) lhs: GpuFlatFwdMemoryExpr<E>,
    pub(in crate::prover::gkr::forward) rhs: GpuFlatFwdMemoryExpr<E>,
    pub(in crate::prover::gkr::forward) dst: *mut E,
}
...
#[repr(C)]
#[derive(Debug)]
pub(in crate::prover::gkr::forward) struct GpuFlatFwdMemoryMaterializeEntry<E> {
    pub(in crate::prover::gkr::forward) expr: GpuFlatFwdMemoryExpr<E>,
    pub(in crate::prover::gkr::forward) dst: *mut E,
}
...
pub(crate) struct GpuFlatForwardStaticDesc<E> {
    pub(in crate::prover::gkr::forward) sources: [*const u8; FLAT_FWD_MAX_SOURCES],
    pub(in crate::prover::gkr::forward) num_sources: u32,

    pub(in crate::prover::gkr::forward) products:
        [GpuFlatFwdProductEntry<E>; FLAT_FWD_MAX_PER_CATEGORY],
    pub(in crate::prover::gkr::forward) num_products: u32,

    pub(in crate::prover::gkr::forward) masks: [GpuFlatFwdMaskEntry<E>; FLAT_FWD_MAX_PER_CATEGORY],
    pub(in crate::prover::gkr::forward) num_masks: u32,

    pub(in crate::prover::gkr::forward) lookup4s:
        [GpuFlatFwdLookup4Entry<E>; FLAT_FWD_MAX_PER_CATEGORY],
    pub(in crate::prover::gkr::forward) num_lookup4s: u32,

    pub(in crate::prover::gkr::forward) bf_pairs:
        [GpuFlatFwdBfPairEntry<E>; FLAT_FWD_MAX_PER_CATEGORY],
    pub(in crate::prover::gkr::forward) num_bf_pairs: u32,

    pub(in crate::prover::gkr::forward) e4_pairs:
        [GpuFlatFwdE4PairEntry<E>; FLAT_FWD_MAX_PER_CATEGORY],
    pub(in crate::prover::gkr::forward) num_e4_pairs: u32,

    pub(in crate::prover::gkr::forward) cached_denses:
        [GpuFlatFwdCachedDensEntry<E>; FLAT_FWD_MAX_PER_CATEGORY],
    pub(in crate::prover::gkr::forward) num_cached_denses: u32,

    pub(in crate::prover::gkr::forward) bf_minus_mults:
        [GpuFlatFwdBfMinusMultEntry<E>; FLAT_FWD_MAX_PER_CATEGORY],
    pub(in crate::prover::gkr::forward) num_bf_minus_mults: u32,

    pub(in crate::prover::gkr::forward) e4_minus_mults:
        [GpuFlatFwdE4MinusMultEntry<E>; FLAT_FWD_MAX_PER_CATEGORY],
    pub(in crate::prover::gkr::forward) num_e4_minus_mults: u32,

    pub(in crate::prover::gkr::forward) bf_unbalanceds:
        [GpuFlatFwdBfUnbalancedEntry<E>; FLAT_FWD_MAX_PER_CATEGORY],
    pub(in crate::prover::gkr::forward) num_bf_unbalanceds: u32,

    pub(in crate::prover::gkr::forward) e4_unbalanceds:
        [GpuFlatFwdE4UnbalancedEntry<E>; FLAT_FWD_MAX_PER_CATEGORY],
    pub(in crate::prover::gkr::forward) num_e4_unbalanceds: u32,

    pub(in crate::prover::gkr::forward) mapped_bf_pairs:
        [GpuFlatFwdMappedBfPairEntry<E>; FLAT_FWD_MAX_PER_CATEGORY],
    pub(in crate::prover::gkr::forward) num_mapped_bf_pairs: u32,

    pub(in crate::prover::gkr::forward) mapped_e4_pairs:
        [GpuFlatFwdMappedE4PairEntry<E>; FLAT_FWD_MAX_PER_CATEGORY],
    pub(in crate::prover::gkr::forward) num_mapped_e4_pairs: u32,

    pub(in crate::prover::gkr::forward) mapped_cached_denses:
        [GpuFlatFwdMappedCachedDensEntry<E>; FLAT_FWD_MAX_PER_CATEGORY],
    pub(in crate::prover::gkr::forward) num_mapped_cached_denses: u32,

    pub(in crate::prover::gkr::forward) mapped_e4_minus_mults:
        [GpuFlatFwdMappedE4MinusMultEntry<E>; FLAT_FWD_MAX_PER_CATEGORY],
    pub(in crate::prover::gkr::forward) num_mapped_e4_minus_mults: u32,

    pub(in crate::prover::gkr::forward) mapped_e4_unbalanceds:
        [GpuFlatFwdMappedE4UnbalancedEntry<E>; FLAT_FWD_MAX_PER_CATEGORY],
    pub(in crate::prover::gkr::forward) num_mapped_e4_unbalanceds: u32,

    pub(in crate::prover::gkr::forward) memory_products:
        [GpuFlatFwdMemoryProductEntry<E>; FLAT_FWD_MAX_PER_CATEGORY],
    pub(in crate::prover::gkr::forward) num_memory_products: u32,

    pub(in crate::prover::gkr::forward) memory_materializes:
        [GpuFlatFwdMemoryMaterializeEntry<E>; FLAT_FWD_MAX_PER_CATEGORY],
    pub(in crate::prover::gkr::forward) num_memory_materializes: u32,
}
...
pub(in crate::prover::gkr::forward) fn launch_flat_forward_layer<
...
pub(in crate::prover::gkr::forward) fn flat_desc_has_work<E>(
    desc: &GpuFlatForwardStaticDesc<E>,
) -> bool {
    desc.num_products
        | desc.num_masks
