...
pub(super) fn launch_forward_setup_generic_lookup<E: crate::prover::gkr::SetupKernels>(
...
/// `crate::prover::gkr::SetupKernels` supertrait aggregates this with the
...
impl SetupKernels for crate::primitives::field::E4 {
    const FORWARD_SETUP_GENERIC_LOOKUP: GpuGKRForwardSetupGenericLookupSignature<Self> =
        ab_gkr_forward_setup_generic_lookup_e4_kernel;
}
