use crate::proof::{grand_product_accumulator_from_explicit_evaluations, prove, GpuGKRProofJob};
...
where
    E: FieldExtension<BF>
        + Field
        + gpu_ops::simple::SetByRef
        + gpu_ops::simple::SetByVal
        + gpu_gkr::GpuKernels,
    gpu_ops::simple::Add: gpu_ops::simple::BinaryOp<E, E, E>,
    gpu_ops::simple::Add: gpu_ops::simple::BinaryOp<BF, E, E>,
    gpu_ops::simple::Add: gpu_ops::simple::BinaryOp<E, BF, E>,
    gpu_ops::simple::Add: gpu_ops::simple::BinaryOp<BF, BF, BF>,
    gpu_ops::simple::Mul: gpu_ops::simple::BinaryOp<E, E, E>,
    gpu_ops::simple::Mul: gpu_ops::simple::BinaryOp<BF, E, E>,
    gpu_ops::simple::Mul: gpu_ops::simple::BinaryOp<E, BF, E>,
    gpu_ops::simple::Mul: gpu_ops::simple::BinaryOp<BF, BF, BF>,
    gpu_ops::simple::Sub: gpu_ops::simple::BinaryOp<E, E, E>,
    gpu_ops::simple::Sub: gpu_ops::simple::BinaryOp<E, BF, E>,
    gpu_ops::simple::Sub: gpu_ops::simple::BinaryOp<BF, BF, BF>,
{
