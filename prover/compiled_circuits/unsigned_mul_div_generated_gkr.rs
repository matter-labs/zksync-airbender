    ...
    W::I32: Copy,
{
    ...
    let v_96 = v_88.widen();
    let v_97 = W::U16::split_widening_product(&v_76, &v_96).0;
    let v_98 = v_97.widen();
    let v_99 = v_98.shl(8u32);
    let mut v_100 = v_95;
    W::U32::add_assign(&mut v_100, &v_99);
    let v_101 = W::Mask::or(&v_2, &v_3);
    let v_102 = WitnessComputationCore::select(&v_101, &v_23, &v_12);
    let v_103 = v_102.truncate();
    let v_104 = v_103.widen();
    let mut v_105 = v_100;
    W::U32::add_assign(&mut v_105, &v_104);
    let v_106 = WitnessComputationCore::select(&v_38, &v_24, &v_12);
    let v_107 = WitnessComputationCore::select(&v_101, &v_18, &v_106);
    let v_108 = v_107.truncate();
    let v_109 = v_108.widen();
    let mut v_110 = v_105;
    W::U32::sub_assign(&mut v_110, &v_109);
    let v_111 = v_110.shr(16u32);
    let v_112 = v_111.truncate();
    witness_proxy.set_witness_place_u16(15usize, v_112);
    let v_114 = W::U16::split_widening_product(&v_91, &v_96).0;
    let v_115 = v_114.widen();
    let mut v_116 = v_12;
    W::U32::add_assign(&mut v_116, &v_115);
    let v_117 = v_61.widen();
    let v_118 = W::U16::split_widening_product(&v_117, &v_79).0;
    let v_119 = v_118.widen();
    let mut v_120 = v_116;
    W::U32::add_assign(&mut v_120, &v_119);
    let v_121 = v_11.shr(16u32);
    let v_122 = v_121.truncate();
    let v_123 = v_122.truncate();
    let v_124 = v_123.widen();
    let v_125 = W::U16::split_widening_product(&v_76, &v_124).0;
    let v_126 = v_125.widen();
    let mut v_127 = v_120;
    W::U32::add_assign(&mut v_127, &v_126);
    let v_128 = v_29.shr(24u32);
    let v_129 = v_128.truncate();
    let v_130 = v_129.truncate();
    let v_131 = v_35.shr(24u32);
    let v_132 = v_131.truncate();
    let v_133 = v_132.truncate();
    let v_134 = v_11.shr(24u32);
    let v_135 = v_134.truncate();
    let v_136 = v_135.truncate();
    let v_137 = WitnessComputationCore::select(&v_38, &v_136, &v_41);
    let v_138 = WitnessComputationCore::select(&v_2, &v_133, &v_137);
    let v_139 = WitnessComputationCore::select(&v_3, &v_130, &v_138);
    let v_140 = v_139.widen();
    let v_141 = W::U16::split_widening_product(&v_140, &v_79).0;
    let v_142 = v_141.widen();
    let v_143 = v_142.shl(8u32);
    let mut v_144 = v_127;
    W::U32::add_assign(&mut v_144, &v_143);
    let v_145 = v_136.widen();
    let v_146 = W::U16::split_widening_product(&v_76, &v_145).0;
    let v_147 = v_146.widen();
    let v_148 = v_147.shl(8u32);
    let mut v_149 = v_144;
    W::U32::add_assign(&mut v_149, &v_148);
    let v_150 = W::U16::split_widening_product(&v_117, &v_96).0;
    let v_151 = v_150.widen();
    let v_152 = v_151.shl(8u32);
    let mut v_153 = v_149;
    W::U32::add_assign(&mut v_153, &v_152);
    let v_154 = W::U16::split_widening_product(&v_91, &v_124).0;
    let v_155 = v_154.widen();
    let v_156 = v_155.shl(8u32);
    let mut v_157 = v_153;
    W::U32::add_assign(&mut v_157, &v_156);
    let v_158 = v_102.shr(16u32);
    let mut v_159 = v_157;
    W::U32::add_assign(&mut v_159, &v_158);
    let mut v_160 = v_159;
    W::U32::add_assign(&mut v_160, &v_111);
    let v_161 = v_107.shr(16u32);
    let mut v_162 = v_160;
    W::U32::sub_assign(&mut v_162, &v_161);
    let v_163 = v_162.shr(16u32);
    let v_164 = v_163.truncate();
    witness_proxy.set_witness_place_u16(16usize, v_164);
    let v_166 = W::U16::split_widening_product(&v_140, &v_96).0;
    let v_167 = v_166.widen();
    let mut v_168 = v_12;
    W::U32::add_assign(&mut v_168, &v_167);
    let v_169 = W::U16::split_widening_product(&v_117, &v_124).0;
    let v_170 = v_169.widen();
    let mut v_171 = v_168;
    W::U32::add_assign(&mut v_171, &v_170);
    let v_172 = W::U16::split_widening_product(&v_91, &v_145).0;
    let v_173 = v_172.widen();
    let mut v_174 = v_171;
    W::U32::add_assign(&mut v_174, &v_173);
    let v_175 = W::U16::split_widening_product(&v_140, &v_124).0;
    let v_176 = v_175.widen();
    let v_177 = v_176.shl(8u32);
    let mut v_178 = v_174;
    W::U32::add_assign(&mut v_178, &v_177);
    let mut v_179 = v_178;
    W::U32::add_assign(&mut v_179, &v_177);
    let mut v_180 = v_179;
    W::U32::add_assign(&mut v_180, &v_163);
    let v_181 = WitnessComputationCore::select(&v_38, &v_25, &v_12);
    let v_182 = v_181.truncate();
    let v_183 = v_182.widen();
    let mut v_184 = v_180;
    W::U32::sub_assign(&mut v_184, &v_183);
