    ...
    W::I32: Copy,
{
    ...
    let mut v_2 = v_1;
    W::U16::add_assign(&mut v_2, &v_0);
    let v_3 = v_2.get_lowest_bits(1u32);
    let v_4 = WitnessComputationCore::into_mask(v_3);
    witness_proxy.set_witness_place_boolean(6usize, v_4);
    let v_6 = v_2.shr(1u32);
    ...
    W::I32: Copy,
{
    ...
    let v_3 = witness_proxy.get_memory_place(10usize);
    let v_4 = witness_proxy.get_memory_place(16usize);
    ...
    let v_8 = W::Field::constant(BabyBearField(65536u32));
    let mut v_9 = v_1;
    W::Field::mul_assign(&mut v_9, &v_8);
    let mut v_10 = v_7;
    W::Field::add_assign_product(&mut v_10, &v_9, &v_3);
    let v_11 = W::Field::constant(BabyBearField(2013200385u32));
    let mut v_12 = v_1;
    W::Field::mul_assign(&mut v_12, &v_11);
    let mut v_13 = v_10;
    W::Field::add_assign_product(&mut v_13, &v_12, &v_4);
    let mut v_14 = v_13;
    W::Field::add_assign_product(&mut v_14, &v_8, &v_0);
    let mut v_15 = v_14;
    W::Field::add_assign_product(&mut v_15, &v_8, &v_2);
    let mut v_16 = v_15;
    W::Field::add_assign_product(&mut v_16, &v_11, &v_3);
    let mut v_17 = v_16;
    W::Field::add_assign_product(&mut v_17, &v_11, &v_5);
    let v_18 = W::Field::constant(BabyBearField(2013134849u32));
    let mut v_19 = v_17;
    ...
    W::I32: Copy,
{
    ...
    let v_5 = witness_proxy.get_memory_place(10usize);
    let v_6 = witness_proxy.get_memory_place(11usize);
    let v_7 = witness_proxy.get_memory_place(16usize);
    let v_8 = witness_proxy.get_memory_place(17usize);
    let v_9 = witness_proxy.get_witness_place(6usize);
    let v_10 = witness_proxy.get_witness_place(7usize);
    let v_11 = W::Field::constant(BabyBearField(0u32));
    let v_12 = W::Field::constant(BabyBearField(1u32));
    let mut v_13 = v_2;
    ...
    let v_18 = W::Field::constant(BabyBearField(2013265920u32));
    let mut v_19 = v_2;
    W::Field::mul_assign(&mut v_19, &v_18);
    let mut v_20 = v_17;
    W::Field::add_assign_product(&mut v_20, &v_19, &v_7);
    let v_21 = W::Field::constant(BabyBearField(2013200385u32));
    let mut v_22 = v_2;
    W::Field::mul_assign(&mut v_22, &v_21);
    let mut v_23 = v_20;
    W::Field::add_assign_product(&mut v_23, &v_22, &v_8);
    let mut v_24 = v_23;
    W::Field::add_assign_product(&mut v_24, &v_12, &v_0);
    let mut v_25 = v_24;
    W::Field::add_assign_product(&mut v_25, &v_15, &v_1);
    let mut v_26 = v_25;
    W::Field::add_assign_product(&mut v_26, &v_12, &v_3);
    let mut v_27 = v_26;
    W::Field::add_assign_product(&mut v_27, &v_15, &v_4);
    let mut v_28 = v_27;
    W::Field::add_assign_product(&mut v_28, &v_18, &v_5);
    let mut v_29 = v_28;
    W::Field::add_assign_product(&mut v_29, &v_21, &v_6);
    let mut v_30 = v_29;
    W::Field::add_assign_product(&mut v_30, &v_18, &v_9);
    let v_31 = W::Field::constant(BabyBearField(2013265919u32));
    let mut v_32 = v_30;
    ...
    W::I32: Copy,
{
    ...
    let v_2 = witness_proxy.get_memory_place(17usize);
    ...
    witness_proxy.set_witness_place_boolean(8usize, v_11);
}
#[allow(unused_variables)]
#[inline(always)]
    ...
    W::I32: Copy,
{
    ...
    let v_11 = W::Field::constant(BabyBearField(2013265857u32));
    let v_12 = v_11.as_integer();
    let v_13 = v_12.truncate();
    let v_14 = W::Mask::constant(true);
    let v_15 = witness_proxy.maybe_lookup::<1usize, 1usize>(&[v_10], v_13, v_14);
    let v_16 = v_15[0usize];
    witness_proxy.set_witness_place(9usize, v_16);
}
#[allow(unused_variables)]
#[inline(always)]
    ...
    W::I32: Copy,
{
    ...
    witness_proxy.set_scratch_place(4usize, v_2);
}
#[allow(unused_variables)]
#[inline(always)]
fn eval_fn_11<
    ...
    W::I32: Copy,
{
    ...
    let mut v_3 = v_2;
    W::Field::sub_assign(&mut v_3, &v_0);
    let mut v_4 = v_3;
    W::Field::sub_assign(&mut v_4, &v_1);
    witness_proxy.set_scratch_place(6usize, v_4);
}
#[allow(unused_variables)]
#[inline(always)]
fn eval_fn_14<
    ...
    W::I32: Copy,
{
    ...
    let v_4 = witness_proxy.get_memory_place(16usize);
    let v_5 = witness_proxy.get_memory_place(17usize);
    let v_6 = witness_proxy.get_witness_place(6usize);
    let v_7 = witness_proxy.get_witness_place(7usize);
    let v_8 = W::Field::constant(BabyBearField(0u32));
    let mut v_9 = v_8;
    W::Field::add_assign_product(&mut v_9, &v_0, &v_4);
    let mut v_10 = v_0;
    W::Field::mul_assign(&mut v_10, &v_2);
    let mut v_11 = v_9;
    W::Field::sub_assign(&mut v_11, &v_10);
    let v_12 = W::Field::constant(BabyBearField(1744970275u32));
    let mut v_13 = v_0;
    W::Field::mul_assign(&mut v_13, &v_12);
    let mut v_14 = v_11;
    W::Field::add_assign_product(&mut v_14, &v_13, &v_3);
    let v_15 = W::Field::constant(BabyBearField(268295646u32));
    let mut v_16 = v_0;
    W::Field::mul_assign(&mut v_16, &v_15);
    let mut v_17 = v_14;
    W::Field::add_assign_product(&mut v_17, &v_16, &v_5);
    let mut v_18 = v_17;
    W::Field::add_assign(&mut v_18, &v_2);
    let v_19 = W::Field::constant(BabyBearField(1064793976u32));
    let mut v_20 = v_18;
    W::Field::add_assign_product(&mut v_20, &v_19, &v_1);
    let mut v_21 = v_20;
    W::Field::add_assign_product(&mut v_21, &v_15, &v_3);
    let v_22 = W::Field::constant(BabyBearField(232644062u32));
    let mut v_23 = v_21;
    W::Field::add_assign_product(&mut v_23, &v_22, &v_6);
    let v_24 = W::Field::constant(BabyBearField(116322031u32));
    let mut v_25 = v_23;
    W::Field::add_assign_product(&mut v_25, &v_24, &v_7);
    witness_proxy.set_scratch_place(8usize, v_25);
}
#[allow(unused_variables)]
#[inline(always)]
fn eval_fn_16<
    ...
    W::I32: Copy,
{
    ...
    let mut v_6 = v_5;
    W::Field::add_assign_product(&mut v_6, &v_2, &v_4);
    let mut v_7 = v_1;
    ...
    let v_10 = W::Field::constant(BabyBearField(268295646u32));
    let mut v_11 = v_9;
    W::Field::add_assign_product(&mut v_11, &v_10, &v_0);
    let v_12 = W::Field::constant(BabyBearField(536591292u32));
    let mut v_13 = v_11;
    W::Field::add_assign_product(&mut v_13, &v_12, &v_3);
    witness_proxy.set_scratch_place(9usize, v_13);
}
#[allow(unused_variables)]
#[inline(always)]
fn eval_fn_17<
    ...
    W::I32: Copy,
{
    ...
    let v_5 = W::Field::constant(BabyBearField(268295646u32));
    let mut v_6 = v_0;
    W::Field::mul_assign(&mut v_6, &v_5);
    let mut v_7 = v_4;
    W::Field::add_assign_product(&mut v_7, &v_6, &v_2);
    witness_proxy.set_scratch_place(10usize, v_7);
}
#[allow(unused_variables)]
#[inline(always)]
fn eval_fn_18<
    ...
    W::I32: Copy,
{
    ...
    let mut v_7 = v_6;
    W::Field::add_assign_product(&mut v_7, &v_0, &v_3);
    let mut v_8 = v_7;
    W::Field::add_assign_product(&mut v_8, &v_1, &v_4);
    let mut v_9 = v_8;
    W::Field::add_assign_product(&mut v_9, &v_2, &v_5);
    witness_proxy.set_scratch_place(11usize, v_9);
}
#[allow(unused_variables)]
#[inline(always)]
fn eval_fn_19<
    ...
    W::I32: Copy,
{
    ...
    let mut v_8 = v_7;
    W::Field::add_assign_product(&mut v_8, &v_3, &v_4);
    let mut v_9 = v_0;
    W::Field::mul_assign(&mut v_9, &v_5);
    let mut v_10 = v_8;
    W::Field::sub_assign(&mut v_10, &v_9);
    let mut v_11 = v_2;
    W::Field::mul_assign(&mut v_11, &v_4);
    let mut v_12 = v_10;
    ...
    witness_proxy.set_scratch_place(13usize, v_14);
}
#[allow(unused_variables)]
#[inline(always)]
fn eval_fn_21<
    ...
    W::I32: Copy,
{
    ...
    let v_1 = witness_proxy.get_scratch_place(6usize);
    let v_2 = witness_proxy.get_scratch_place(7usize);
    let v_3 = witness_proxy.get_scratch_place(12usize);
    let v_4 = witness_proxy.get_scratch_place(13usize);
    let v_5 = W::Field::constant(BabyBearField(0u32));
    let mut v_6 = v_5;
    ...
    W::I32: Copy,
{
    ...
    let v_5 = W::Field::constant(BabyBearField(0u32));
    let mut v_6 = v_5;
    W::Field::add_assign_product(&mut v_6, &v_1, &v_4);
    let mut v_7 = v_6;
    W::Field::add_assign_product(&mut v_7, &v_2, &v_4);
    let mut v_8 = v_0;
    ...
    W::Field::sub_assign(&mut v_11, &v_10);
    let mut v_12 = v_11;
    W::Field::add_assign(&mut v_12, &v_3);
    let mut v_13 = v_12;
    W::Field::sub_assign(&mut v_13, &v_1);
    witness_proxy.set_scratch_place(16usize, v_13);
}
#[allow(unused_variables)]
#[inline(always)]
fn eval_fn_24<
    ...
    W::I32: Copy,
{
    ...
    let v_1 = witness_proxy.get_scratch_place(6usize);
    let v_2 = witness_proxy.get_scratch_place(7usize);
    let v_3 = witness_proxy.get_scratch_place(15usize);
    let v_4 = witness_proxy.get_scratch_place(16usize);
    let v_5 = W::Field::constant(BabyBearField(0u32));
    let mut v_6 = v_5;
    W::Field::add_assign_product(&mut v_6, &v_0, &v_3);
    let mut v_7 = v_6;
    ...
    W::I32: Copy,
{
    ...
    let v_3 = W::Field::constant(BabyBearField(1207959463u32));
    let v_4 = W::Field::constant(BabyBearField(1476394949u32));
    let mut v_5 = v_0;
    ...
    let mut v_7 = v_6;
    W::Field::add_assign(&mut v_7, &v_1);
    let v_8 = W::Field::constant(BabyBearField(805306458u32));
    let mut v_9 = v_7;
    ...
    witness_proxy.set_scratch_place(18usize, v_11);
}
#[allow(unused_variables)]
#[inline(always)]
fn eval_fn_26<
...
>(
    ...
    W::I32: Copy,
{
    let v_0 = witness_proxy.get_scratch_place(18usize);
    let v_1 = witness_proxy.get_scratch_place(19usize);
...
>(
    ...
    W::I32: Copy,
{
    let v_0 = witness_proxy.get_scratch_place(11usize);
    let v_1 = witness_proxy.get_scratch_place(14usize);
    let v_2 = witness_proxy.get_scratch_place(17usize);
    let v_3 = witness_proxy.get_scratch_place_u16(20usize);
