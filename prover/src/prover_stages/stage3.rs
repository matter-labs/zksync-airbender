            ...
            for thread_idx in 0..geometry.len() {
                ...
                Worker::smart_spawn(
                    ...
                    for _i in 0..chunk_size {
                        ...
                        use crate::prover_stages::unrolled_prover::quotient_parts::evaluate_generic_constraints;
                        ...
                        if process_delegations {
                            use crate::prover_stages::unrolled_prover::quotient_parts::evaluate_delegation_processing_conventions;
                        ...
                        use crate::prover_stages::unrolled_prover::quotient_parts::evaluate_range_check_16_over_variables;
                        ...
                        use crate::prover_stages::unrolled_prover::quotient_parts::evaluate_range_check_16_over_expressions;
                        ...
                        if process_shuffle_ram_init {
                            use crate::prover_stages::unrolled_prover::quotient_parts::evaluate_memory_init_teardown_range_checks;
                        ...
                        use crate::prover_stages::unrolled_prover::quotient_parts::evaluate_timestamp_range_check_expressions;
                        ...
                        use crate::prover_stages::unrolled_prover::quotient_parts::evaluate_width_3_lookups;
                        ...
                        if compiled_circuit.stage_2_layout
                            .intermediate_poly_for_range_check_16_multiplicity.num_elements() > 0 {
                                use crate::prover_stages::unrolled_prover::quotient_parts::evaluate_width_1_range_check_multiplicity;
                        ...
                        // generic lookup
                        use crate::prover_stages::unrolled_prover::quotient_parts::evaluate_width_3_lookups_multiplicity;
                        ...
                        if handle_delegation_requests {
                            use crate::prover_stages::unrolled_prover::quotient_parts::evaluate_delegation_requests;
                        ...
                        if process_shuffle_ram_init {
                            use crate::prover_stages::unrolled_prover::quotient_parts::evaluate_memory_init_teardown_padding;
                        ...
                        use crate::prover_stages::unrolled_prover::quotient_parts::evaluate_memory_queries_accumulation;
