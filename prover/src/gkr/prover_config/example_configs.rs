    ...
    match trace_len_log_2 {
        20 => ProverConfig {
            ...
            whir_schedule: WhirSchedule {
                ...
                whir_queries_schedule: vec![63, 10, 5, 4, 3],
                whir_steps_lde_factors: vec![128, 4096, 32768, 524288],
                whir_pow_schedule: vec![28, 17, 20, 20, 23],
            },
        },
        22 => ProverConfig {
            lde_factor: DEFAULT_LDE_FACTOR,
            ...
            whir_schedule: WhirSchedule {
                ...
                whir_queries_schedule: vec![63, 14, 6, 4, 3],
                whir_steps_lde_factors: vec![32, 1024, 32768, 524288],
                whir_pow_schedule: vec![28, 20, 20, 20, 23],
            },
        },
        24 => ProverConfig {
            lde_factor: DEFAULT_LDE_FACTOR,
            ...
            whir_schedule: WhirSchedule {
                ...
                whir_queries_schedule: vec![63, 22, 9, 5, 4, 3],
                whir_steps_lde_factors: vec![8, 256, 8192, 32768, 524288],
                whir_pow_schedule: vec![28, 23, 16, 15, 20, 23],
            },
        },
        _ => {
            unimplemented!("TODO");
