...
#[derive(Debug)]
pub struct LookupBaseExtNoCacheMinusBaseExtWithCacheGKRRelation {
    pub masked_input: (GKRAddress, NoFieldVectorLookupRelation),
    pub setup: (GKRAddress, GKRAddress),
    pub outputs: [GKRAddress; 2],
}

impl<F: PrimeField, E: FieldExtension<F> + Field> BatchedGKRKernel<F, E>
    for LookupBaseExtNoCacheMinusBaseExtWithCacheGKRRelation
{
    ...
    fn terms(
        ...
        num_term.add_product_ext_by_linear_base(*d, a.clone());
        num_term
            .add_linear_base_scaled_by_ext(a, challenge_constants.lookup_challenges_additive_part);
        ...
        den_term.add_product_ext_by_linear_base(*d, b.clone());
        den_term
            .add_linear_base_scaled_by_ext(b, challenge_constants.lookup_challenges_additive_part);
