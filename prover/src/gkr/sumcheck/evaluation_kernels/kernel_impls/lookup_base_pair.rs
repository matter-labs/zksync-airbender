    ...
    for LookupBasePairGKRRelation<F, E>
{
    ...
    fn evaluate_forward_over_storage(
        ...
        let kernel = LookupBasePairGKRRelationKernel::<F, E>::new(self.lookup_additive_challenge);
...
impl<F: PrimeField, E: FieldExtension<F> + Field> LookupBasePairGKRRelationKernel<F, E> {
...
impl<F: PrimeField, E: FieldExtension<F> + Field>
    MixedFieldsInOutFixedSizesEvaluationKernelCore<F, E, 2, 0, 2>
