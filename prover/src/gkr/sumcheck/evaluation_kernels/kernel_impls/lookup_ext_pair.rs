...
#[derive(Debug)]
pub struct LookupExtensionPairGKRRelation<F: PrimeField, E: FieldExtension<F> + Field> {
...
impl<F: PrimeField, E: FieldExtension<F> + Field> BatchedGKRKernel<F, E>
    for LookupExtensionPairGKRRelation<F, E>
{
    ...
    fn evaluate_forward_over_storage(
        ...
        let kernel =
            LookupExtensionPairGKRRelationKernel::<F, E>::new(self.lookup_additive_challenge);
...
impl<F: PrimeField, E: FieldExtension<F> + Field> LookupExtensionPairGKRRelationKernel<F, E> {
...
impl<F: PrimeField, E: FieldExtension<F> + Field>
    ExtensionFieldInOutFixedSizesEvaluationKernelCore<F, E, 2, 2>
    for LookupExtensionPairGKRRelationKernel<F, E>
{
    #[inline(always)]
    fn pointwise_eval(&self, input: &[ExtensionFieldRepresentation<F, E>; 2]) -> [E; 2] {
    ...
    fn pointwise_eval_by_ref(&self, _input: [&ExtensionFieldRepresentation<F, E>; 2]) -> [E; 2] {
        todo!()
    }
}

impl<F: PrimeField, E: FieldExtension<F> + Field>
    ExtensionFieldInOutFixedSizesEvaluationKernel<F, E, 2, 2>
    for LookupExtensionPairGKRRelationKernel<F, E>
{
    // #[inline(always)]
...
fn pointwise_eval_impl<F: PrimeField, E: FieldExtension<F> + Field>(
    ...
    b.add_assign(lookup_additive_challenge);
