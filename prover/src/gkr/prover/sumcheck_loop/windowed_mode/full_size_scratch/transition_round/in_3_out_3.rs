    ...
    for TransitionRoundWindowIn3Out3
{
    ...
    fn read_then_fold_and_interpolate_base(
        ...
        read_base_then_fold_and_interpolate(dst, src, buffer, prefix, input_size, row);
    }
    ...
    fn read_then_fold_base_without_interpolation(
        ...
        read_base_then_fold_without_interpolation(dst, src, buffer, prefix, input_size, row);
    }
    ...
    fn read_then_fold_and_interpolate_ext(
        ...
        read_ext_then_fold_and_interpolate(dst, src, buffer, prefix, input_size, row);
    }
    ...
    fn read_then_fold_ext_without_interpolation(
        ...
        read_ext_then_fold_without_interpolation(dst, src, buffer, prefix, input_size, row);
    }
