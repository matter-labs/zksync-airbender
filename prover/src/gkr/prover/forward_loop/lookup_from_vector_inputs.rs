...
>(
    ...
    if super::avx512::enabled::<F, E>(trace_len) {
        return super::avx512::masked_lookup_with_setup(input, setup, outputs, gkr_storage, expected_output_layer, trace_len, lookup_additive_challenge, worker);
    }
...
>(
    ...
    #[cfg(all(target_arch = "x86_64", target_feature = "avx2"))]
    if super::avx512::enabled::<F, E>(trace_len) {
        return super::avx512::lookup_ext_pair(inputs, outputs, gkr_storage, expected_output_layer, trace_len, lookup_additive_challenge, worker);
    }
...
>(
    ...
    #[cfg(all(target_arch = "x86_64", target_feature = "avx2"))]
    if super::avx512::enabled::<F, E>(trace_len) {
        return super::avx512::lookup_unbalanced_ext(inputs, remainder, outputs, gkr_storage, expected_output_layer, trace_len, lookup_additive_challenge, worker);
    }
    let kernel =
...
>(
    ...
    #[cfg(all(target_arch = "x86_64", target_feature = "avx2"))]
    if super::avx512::enabled::<F, E>(trace_len) {
        return super::avx512::lookup_ext_minus_multiplicity(input, setup, outputs, gkr_storage, expected_output_layer, trace_len, lookup_additive_challenge, worker);
    }
    let kernel =
