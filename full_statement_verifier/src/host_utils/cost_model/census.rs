...
pub static CENSUS_TABLES: &[(FsvProgram, BlakeMode, CensusTable)] = &[
    (
        ...
        CensusTable {
            c0: [566698, 72299, 41669, 0, 330371, 0, 32865, 0, 0, 0],
            v: &[
                (
                    CircuitId::Riscv(1),
                    [637912, 77343, 48422, 0, 267897, 0, 57484, 0, 0, 0],
                ),
                (
                    CircuitId::Riscv(2),
                    [653601, 78464, 48718, 0, 277832, 0, 58730, 0, 0, 0],
                ),
                (
                    CircuitId::Riscv(3),
                    [662498, 79120, 49003, 0, 281888, 0, 58800, 0, 0, 0],
                ),
                (
                    CircuitId::Riscv(4),
                ...
                (
                    CircuitId::Riscv(16),
                    [626700, 76706, 48585, 0, 267016, 0, 57491, 0, 0, 0],
                ),
                (
                    CircuitId::Riscv(17),
                ...
                (
                    ...
                    [1919563, 164240, 57275, 0, 799263, 0, 111489, 0, 0, 0],
                ),
                (
    ...
    (
        ...
        BlakeMode::Compression,
        CensusTable {
            c0: [564248, 71704, 41729, 0, 322001, 0, 32746, 0, 0, 0],
            v: &[
                (
                    CircuitId::Riscv(1),
                    [637912, 77343, 48422, 0, 267897, 0, 57484, 0, 0, 0],
