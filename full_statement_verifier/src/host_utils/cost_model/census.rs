...
pub static CENSUS_TABLES: &[(FsvProgram, BlakeMode, CensusTable)] = &[
    (
        ...
        CensusTable {
            c0: [567199, 72795, 42145, 0, 330371, 0, 32865, 0, 0, 0],
            v: &[
                (
                    CircuitId::Riscv(1),
                    [637979, 77398, 48395, 0, 267897, 0, 57484, 0, 0, 0],
                ),
                (
                    CircuitId::Riscv(2),
                    [653519, 78395, 48713, 0, 277832, 0, 58730, 0, 0, 0],
                ),
                (
                    CircuitId::Riscv(3),
                    [662635, 79246, 48989, 0, 281888, 0, 58800, 0, 0, 0],
                ),
                (
                    CircuitId::Riscv(4),
                    [651097, 78433, 50154, 0, 274923, 0, 58177, 0, 0, 0],
                ),
                (
                    CircuitId::Riscv(16),
                    [626815, 76837, 48628, 0, 267016, 0, 57491, 0, 0, 0],
                ),
                (
                    CircuitId::Riscv(17),
                    [639361, 77561, 48967, 0, 272097, 0, 58128, 0, 0, 0],
                ),
                (
                    CircuitId::Delegation(1991),
                    [1919518, 164222, 57291, 0, 799263, 0, 111489, 0, 0, 0],
                ),
                (
                    CircuitId::Delegation(1994),
                    [979037, 91616, 50253, 0, 402478, 0, 65835, 0, 0, 0],
                ),
                (
                    CircuitId::Delegation(1995),
                    [996941, 94893, 50812, 0, 408702, 0, 67914, 0, 0, 0],
                ),
            ],
        },
    ),
    (
        ...
        BlakeMode::Compression,
        CensusTable {
            c0: [563709, 71090, 41687, 0, 322001, 0, 32746, 0, 0, 0],
            v: &[
                (
                    CircuitId::Riscv(1),
                    [637979, 77398, 48395, 0, 267897, 0, 57484, 0, 0, 0],
