...
pub static CENSUS_TABLES: &[(FsvProgram, BlakeMode, CensusTable)] = &[
    (
        ...
        CensusTable {
            c0: [23596, 6528, 862, 0, 124092, 0, 455, 0, 0, 0],
            v: &[
                (
                    CircuitId::Riscv(1),
                    [637992, 77390, 48426, 0, 267892, 0, 57484, 0, 0, 0],
                ),
                (
                    CircuitId::Riscv(2),
                    [653662, 78532, 48671, 0, 277827, 0, 58730, 0, 0, 0],
                ),
                (
                    CircuitId::Riscv(3),
                    [662755, 79346, 48912, 0, 281883, 0, 58800, 0, 0, 0],
                ),
                (
                    CircuitId::Riscv(4),
                    [627230, 75215, 47417, 0, 266765, 0, 54880, 0, 0, 0],
                ),
                (
                    CircuitId::Riscv(16),
                    [626697, 76695, 48612, 0, 267011, 0, 57491, 0, 0, 0],
                ),
                (
                    CircuitId::Riscv(17),
                    [639276, 77469, 48957, 0, 272092, 0, 58128, 0, 0, 0],
                ),
                (
                    CircuitId::InitsAndTeardowns,
                    [505050, 62746, 40228, 0, 200778, 0, 29526, 0, 0, 0],
                ),
                (
                    CircuitId::Delegation(1991),
                    [1933065, 166040, 57469, 0, 802001, 0, 111671, 0, 0, 0],
                ),
                (
                    CircuitId::Delegation(1994),
                    [1007489, 95616, 52354, 0, 414701, 0, 68432, 0, 0, 0],
                ),
                (
                    CircuitId::Delegation(1995),
                    [1010121, 95785, 50950, 0, 411179, 0, 68117, 0, 0, 0],
                ),
                (
    ...
    (
        ...
        BlakeMode::Compression,
        CensusTable {
            c0: [20575, 5121, 796, 0, 116011, 0, 364, 0, 0, 0],
            v: &[
                (
                    CircuitId::Riscv(1),
                    [637992, 77390, 48426, 0, 267892, 0, 57484, 0, 0, 0],
