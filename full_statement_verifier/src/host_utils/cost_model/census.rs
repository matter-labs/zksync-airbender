...
pub static CENSUS_TABLES: &[(FsvProgram, BlakeMode, CensusTable)] = &[
    (
        ...
        CensusTable {
            c0: [23596, 6528, 867, 0, 124092, 0, 455, 0, 0, 0],
            v: &[
                (
                    CircuitId::Riscv(1),
                    [637992, 78136, 48799, 0, 267892, 0, 57484, 0, 0, 0],
                ),
                (
                    CircuitId::Riscv(2),
                    [653662, 79278, 49044, 0, 277827, 0, 58730, 0, 0, 0],
                ),
                (
                    CircuitId::Riscv(3),
                    [662755, 80092, 49285, 0, 281883, 0, 58800, 0, 0, 0],
                ),
                (
                    CircuitId::Riscv(4),
                    [627230, 75905, 47762, 0, 266765, 0, 54880, 0, 0, 0],
                ),
                (
                    CircuitId::Riscv(16),
                    [626697, 77441, 48985, 0, 267011, 0, 57491, 0, 0, 0],
                ),
                (
                    CircuitId::Riscv(17),
                    [639276, 78215, 49330, 0, 272092, 0, 58128, 0, 0, 0],
                ),
                (
                    CircuitId::InitsAndTeardowns,
                    [505050, 63444, 40578, 0, 200778, 0, 29526, 0, 0, 0],
                ),
                (
                    CircuitId::Delegation(1991),
                    [1933065, 166740, 57819, 0, 802001, 0, 111671, 0, 0, 0],
                ),
                (
    ...
    (
        ...
        BlakeMode::Compression,
        CensusTable {
            c0: [20575, 5121, 803, 0, 116011, 0, 364, 0, 0, 0],
            v: &[
                (
                    CircuitId::Riscv(1),
                    [637992, 78136, 48799, 0, 267892, 0, 57484, 0, 0, 0],
