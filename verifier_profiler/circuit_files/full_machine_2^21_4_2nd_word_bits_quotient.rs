...
unsafe fn evaluate_every_row_except_two(
    ...
    let every_row_except_two_last_contribution = {
        let mut accumulated_contribution = {
            let individual_term = {
                let mut individual_term = *(witness.get_unchecked(192usize));
                let t = *(witness_next_row.get_unchecked(18usize));
                individual_term.sub_assign(&t);
                individual_term
            };
            individual_term
        };
        {
            ...
            let contribution = {
                let individual_term = {
                    let mut individual_term = *(witness.get_unchecked(193usize));
            ...
            final_borrow_minus_one.sub_assign_base(&Mersenne31Field::ONE);
            {
                ...
                let contribution = {
                    let individual_term = {
                        ...
                        let aux_low = *(witness.get_unchecked(28usize));
            ...
            }
            {
                ...
                let contribution = {
                    let individual_term = {
                        ...
                        let aux_high = *(witness.get_unchecked(29usize));
...
pub unsafe fn evaluate_quotient(
    ...
    let first_row_contribution = {
        ...
        }
        {
            ...
            let contribution = {
                let individual_term = {
                    let mut individual_term = *(witness.get_unchecked(18usize));
