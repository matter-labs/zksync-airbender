...
contract GKRVerifier {
    ...
    uint256 constant __TEMPLATE_EXPECTED_FINAL_PC       = 1707632; // program's terminal PC — binds the verified statement to this program
    ...
    address constant __TEMPLATE_REGISTRY_ADDRESS          = 0x0000000000000000000000000000000000000000;
