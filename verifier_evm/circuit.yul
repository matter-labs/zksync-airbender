...
function sumcheck_circuit_layer0(ptr, claim, alpha) -> next_ptr, next_claim, next_alpha {
    ...
    {  // InitialGrandProductWithoutCaches: (γ + 0 + α[4] + α²0 + α³(0 + [0]) + α⁴[1] + α⁵[2] + α⁶[3])*(γ + [9] + α[10] + α²[11] + α³(0 + [5]) + α⁴[6] + α⁵[7] + α⁶[8]) = [1]
        let gate := mulmod(gkr_memrel_compress(0, shr(128, calldataload(add(ptr, mul(16, 4)))), 0, add(0, shr(128, calldataload(add(ptr, mul(16, 0))))), shr(128, calldataload(add(ptr, mul(16, 1)))), shr(128, calldataload(add(ptr, mul(16, 2)))), shr(128, calldataload(add(ptr, mul(16, 3))))), gkr_memrel_compress(shr(128, calldataload(add(ptr, mul(16, 9)))), shr(128, calldataload(add(ptr, mul(16, 10)))), shr(128, calldataload(add(ptr, mul(16, 11)))), add(0, shr(128, calldataload(add(ptr, mul(16, 5))))), shr(128, calldataload(add(ptr, mul(16, 6)))), shr(128, calldataload(add(ptr, mul(16, 7)))), shr(128, calldataload(add(ptr, mul(16, 8))))), P)
        acc := add(mulmod(acc, alpha, P), gate)
    }
    {  // InitialGrandProductWithoutCaches: (γ + 0 + α[4] + α²0 + α³(0 + [24]) + α⁴[25] + α⁵[2] + α⁶[3])*(γ + [9] + α[10] + α²[11] + α³(1 + [24]) + α⁴[25] + α⁵[7] + α⁶[8]) = [2]
        let gate := mulmod(gkr_memrel_compress(0, shr(128, calldataload(add(ptr, mul(16, 4)))), 0, add(0, shr(128, calldataload(add(ptr, mul(16, 24))))), shr(128, calldataload(add(ptr, mul(16, 25)))), shr(128, calldataload(add(ptr, mul(16, 2)))), shr(128, calldataload(add(ptr, mul(16, 3))))), gkr_memrel_compress(shr(128, calldataload(add(ptr, mul(16, 9)))), shr(128, calldataload(add(ptr, mul(16, 10)))), shr(128, calldataload(add(ptr, mul(16, 11)))), add(1, shr(128, calldataload(add(ptr, mul(16, 24))))), shr(128, calldataload(add(ptr, mul(16, 25)))), shr(128, calldataload(add(ptr, mul(16, 7)))), shr(128, calldataload(add(ptr, mul(16, 8))))), P)
        acc := add(mulmod(acc, alpha, P), gate)
    }
    {  // InitialGrandProductWithoutCaches: (γ + [16] + α[17] + α²[18] + α³(0 + [12]) + α⁴[13] + α⁵[14] + α⁶[15])*(γ + 2 + α0 + α²0 + α³(0 + [24]) + α⁴[25] + α⁵[22] + α⁶[23]) = [3]
        let gate := mulmod(gkr_memrel_compress(shr(128, calldataload(add(ptr, mul(16, 16)))), shr(128, calldataload(add(ptr, mul(16, 17)))), shr(128, calldataload(add(ptr, mul(16, 18)))), add(0, shr(128, calldataload(add(ptr, mul(16, 12))))), shr(128, calldataload(add(ptr, mul(16, 13)))), shr(128, calldataload(add(ptr, mul(16, 14)))), shr(128, calldataload(add(ptr, mul(16, 15))))), gkr_memrel_compress(2, 0, 0, add(0, shr(128, calldataload(add(ptr, mul(16, 24))))), shr(128, calldataload(add(ptr, mul(16, 25)))), shr(128, calldataload(add(ptr, mul(16, 22)))), shr(128, calldataload(add(ptr, mul(16, 23))))), P)
        acc := add(mulmod(acc, alpha, P), gate)
    }
    {  // InitialGrandProductWithoutCaches: (γ + [16] + α[17] + α²[18] + α³(2 + [24]) + α⁴[25] + α⁵[19] + α⁶[20])*(γ + 2 + α0 + α²0 + α³(0 + [28]) + α⁴[29] + α⁵[26] + α⁶[27]) = [4]
        let gate := mulmod(gkr_memrel_compress(shr(128, calldataload(add(ptr, mul(16, 16)))), shr(128, calldataload(add(ptr, mul(16, 17)))), shr(128, calldataload(add(ptr, mul(16, 18)))), add(2, shr(128, calldataload(add(ptr, mul(16, 24))))), shr(128, calldataload(add(ptr, mul(16, 25)))), shr(128, calldataload(add(ptr, mul(16, 19)))), shr(128, calldataload(add(ptr, mul(16, 20))))), gkr_memrel_compress(2, 0, 0, add(0, shr(128, calldataload(add(ptr, mul(16, 28))))), shr(128, calldataload(add(ptr, mul(16, 29)))), shr(128, calldataload(add(ptr, mul(16, 26)))), shr(128, calldataload(add(ptr, mul(16, 27))))), P)
        acc := add(mulmod(acc, alpha, P), gate)
    }
    {  // LookupFromMaterializedBaseInputWithSetup: 1/(δ + [85]) - [100]/(δ + Cache(0)) = [48]/[49]
        ...
        // let num_out := add(add(mload(add(LOGUP_CHALLS_PTR, 32)), mload(add(GKR_CIRCUIT_CACHE_PTR, mul(32, 0)))), mulmod(sub(mul(2, P), shr(128, calldataload(add(ptr, mul(16, 100))))), add(mload(add(LOGUP_CHALLS_PTR, 32)), shr(128, calldataload(add(ptr, mul(16, 85))))), P))
        // let num_out := add(add(mload(add(LOGUP_CHALLS_PTR, 32)), mload(add(GKR_CIRCUIT_CACHE_PTR, mul(32, 0)))), mulmod(sub(mul(3, P), add(mload(add(LOGUP_CHALLS_PTR, 32)), shr(128, calldataload(add(ptr, mul(16, 85)))))), shr(128, calldataload(add(ptr, mul(16, 100)))), P))
        gate := num_out
        acc := add(mulmod(acc, alpha, P), gate)
    }
    ...
    {  // LookupFromMaterializedBaseInputWithSetup: 1/(δ + [28]) - [101]/(δ + Cache(1)) = [61]/[62]
        ...
        // let num_out := add(add(mload(add(LOGUP_CHALLS_PTR, 32)), mload(add(GKR_CIRCUIT_CACHE_PTR, mul(32, 1)))), mulmod(sub(mul(2, P), shr(128, calldataload(add(ptr, mul(16, 101))))), add(mload(add(LOGUP_CHALLS_PTR, 32)), shr(128, calldataload(add(ptr, mul(16, 28))))), P))
        // let num_out := add(add(mload(add(LOGUP_CHALLS_PTR, 32)), mload(add(GKR_CIRCUIT_CACHE_PTR, mul(32, 1)))), mulmod(sub(mul(3, P), add(mload(add(LOGUP_CHALLS_PTR, 32)), shr(128, calldataload(add(ptr, mul(16, 28)))))), shr(128, calldataload(add(ptr, mul(16, 101)))), P))
        gate := num_out
        acc := add(mulmod(acc, alpha, P), gate)
    }
    let rhs_scaled := mulmod(acc, eq_scale, P)
