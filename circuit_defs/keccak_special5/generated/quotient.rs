...
unsafe fn evaluate_every_row_except_last(
    ...
    let every_row_except_last_contribution = {
        ...
        }
        {
            ...
            let contribution = {
                let individual_term = {
                    ...
                    let table_id = *(witness.get_unchecked(35usize));
                    let mut denom = lookup_argument_linearization_challenges[2];
        ...
        }
        {
            ...
            let contribution = {
                let individual_term = {
                    ...
                    let table_id = *(witness.get_unchecked(72usize));
                    let mut denom = lookup_argument_linearization_challenges[2];
                    denom.mul_assign(&table_id);
                    let mut t = lookup_argument_linearization_challenges[1];
                    t.mul_assign_by_base(&src2);
        ...
        }
        {
            ...
            let contribution = {
                let individual_term = {
                    ...
                    let table_id = *(witness.get_unchecked(172usize));
                    let mut denom = lookup_argument_linearization_challenges[2];
                    denom.mul_assign(&table_id);
                    let mut t = lookup_argument_linearization_challenges[1];
                    t.mul_assign_by_base(&src2);
            ...
            }
            {
                ...
                let contribution = {
                    let individual_term = {
                        ...
                        let mut numerator = memory_argument_gamma;
                        numerator.add_assign(&address_contribution);
                        let previous = *(stage_2.get_unchecked(97usize));
                        numerator.add_assign(&read_value_contribution);
                        let mut denom = numerator;
                        numerator.add_assign(&write_timestamp_contribution);
                        denom.add_assign(&read_timestamp_contribution);
        ...
        }
        {
            ...
            let contribution = {
                let individual_term = {
                    let mut individual_term = *(stage_2_next_row.get_unchecked(111usize));
                    let mut t = *(stage_2.get_unchecked(111usize));
                    t.mul_assign(&*(stage_2.get_unchecked(110usize)));
                    individual_term.sub_assign(&t);
                    individual_term
                };
                individual_term
...
unsafe fn evaluate_last_row_and_zero(
    ...
    let last_row_and_zero_contribution = {
        ...
        }
        {
            ...
            let contribution = {
                let individual_term = {
                    let mut individual_term = *(stage_2.get_unchecked(96usize));
