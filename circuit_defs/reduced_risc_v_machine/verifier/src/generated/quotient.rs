...
unsafe fn evaluate_every_row_except_last(
    ...
    let every_row_except_last_contribution = {
        ...
        }
        {
            ...
            let contribution = {
                let individual_term = {
                    ...
                    let table_id = *(witness.get_unchecked(68usize));
                    let mut denom = lookup_argument_linearization_challenges[2];
        ...
        }
        {
            ...
            let contribution = {
                let individual_term = {
                    ...
                    let table_id = *(witness.get_unchecked(76usize));
                    let mut denom = lookup_argument_linearization_challenges[2];
                    field_ops::mul_assign(&mut denom, &table_id);
                    let mut t = lookup_argument_linearization_challenges[1];
                    field_ops::mul_assign_by_base(&mut t, &src2);
        ...
        }
        {
            ...
            let contribution = {
                let individual_term = {
                    ...
                    let table_id = *(witness.get_unchecked(80usize));
                    let mut denom = lookup_argument_linearization_challenges[2];
                    field_ops::mul_assign(&mut denom, &table_id);
                    let mut t = lookup_argument_linearization_challenges[1];
                    field_ops::mul_assign_by_base(&mut t, &src2);
        ...
        }
        {
            ...
            let contribution = {
                let individual_term = {
                    ...
                    field_ops::add_assign(&mut denom, &t);
                    let accumulator = *(stage_2.get_unchecked(37usize));
        ...
        }
        {
            ...
            let contribution = {
                let individual_term = {
                    let mut individual_term = *(stage_2_next_row.get_unchecked(38usize));
                    let mut t = *(stage_2.get_unchecked(38usize));
                    field_ops::mul_assign(&mut t, &*(stage_2.get_unchecked(37usize)));
                    field_ops::sub_assign(&mut individual_term, &t);
                    individual_term
                };
                individual_term
...
unsafe fn evaluate_every_row_except_two(
    ...
    let every_row_except_two_last_contribution = {
        let mut accumulated_contribution = {
            let individual_term = {
                let mut individual_term = *(witness.get_unchecked(115usize));
                let t = *(witness_next_row.get_unchecked(4usize));
                field_ops::sub_assign(&mut individual_term, &t);
                individual_term
            };
            individual_term
        };
        {
            ...
            let contribution = {
                let individual_term = {
                    let mut individual_term = *(witness.get_unchecked(116usize));
                    let t = *(witness_next_row.get_unchecked(49usize));
                    field_ops::sub_assign(&mut individual_term, &t);
                    individual_term
                };
                individual_term
            ...
            field_ops::sub_assign_base(&mut final_borrow_minus_one, &Mersenne31Field::ONE);
            {
                ...
                let contribution = {
                    let individual_term = {
                        ...
                        let aux_low = *(witness.get_unchecked(12usize));
            ...
            }
            {
                ...
                let contribution = {
                    let individual_term = {
                        ...
                        let aux_high = *(witness.get_unchecked(13usize));
...
pub unsafe fn evaluate_quotient(
    ...
    let first_row_contribution = {
        ...
        }
        {
            ...
            let contribution = {
                let individual_term = {
                    let mut individual_term = *(witness.get_unchecked(4usize));
        ...
        }
        {
            ...
            let contribution = {
                let individual_term = {
                    let mut individual_term = *(witness.get_unchecked(49usize));
