...
unsafe fn evaluate_every_row_except_last(
    ...
    let every_row_except_last_contribution = {
        ...
        }
        {
            ...
            let contribution = {
                let individual_term = {
                    ...
                    field_ops::mul_assign(&mut individual_term, &denom);
                    let mut t = *(stage_2.get_unchecked(27usize));
                    field_ops::mul_assign(&mut t, &numerator);
                    field_ops::sub_assign(&mut individual_term, &t);
                    individual_term
                };
        ...
        }
        {
            ...
            let contribution = {
                let individual_term = {
                    let mut individual_term = *(stage_2_next_row.get_unchecked(30usize));
                    let mut t = *(stage_2.get_unchecked(30usize));
                    field_ops::mul_assign(&mut t, &*(stage_2.get_unchecked(29usize)));
                    field_ops::sub_assign(&mut individual_term, &t);
                    individual_term
                };
                individual_term
        ...
        }
        {
            ...
            let contribution = {
                let individual_term = {
                    ...
                    field_ops::sub_assign(&mut individual_term, &*(stage_2.get_unchecked(20usize)));
                    individual_term
                };
                individual_term
            };
