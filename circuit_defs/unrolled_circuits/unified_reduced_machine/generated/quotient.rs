        ...
        }
        {
            ...
            let contribution = {
                let individual_term = {
                    ...
                    field_ops::add_assign(&mut denom, &*(memory.get_unchecked(31usize)));
                    let mut t = decoder_lookup_argument_linearization_challenges[0usize];
                    field_ops::mul_assign(&mut t, &*(memory.get_unchecked(32usize)));
                    field_ops::add_assign(&mut denom, &t);
                    let mut t = decoder_lookup_argument_linearization_challenges[1usize];
                    field_ops::mul_assign(&mut t, &*(memory.get_unchecked(10usize)));
                    field_ops::add_assign(&mut denom, &t);
                    ...
                    field_ops::mul_assign(&mut t, &*(witness.get_unchecked(6usize)));
                    field_ops::add_assign(&mut denom, &t);
                    let mut individual_term = denom;
        ...
        }
        {
            ...
            let contribution = {
                let individual_term = {
                    ...
                    field_ops::add_assign(&mut numerator, &*(memory.get_unchecked(35usize)));
                    let mut t = state_permutation_argument_linearization_challenges[0];
                    field_ops::mul_assign(&mut t, &*(memory.get_unchecked(36usize)));
                    field_ops::add_assign(&mut numerator, &t);
                    let mut t = state_permutation_argument_linearization_challenges[1];
                    field_ops::mul_assign(&mut t, &*(memory.get_unchecked(37usize)));
                    field_ops::add_assign(&mut numerator, &t);
                    let mut t = state_permutation_argument_linearization_challenges[2];
                    field_ops::mul_assign(&mut t, &*(memory.get_unchecked(38usize)));
                    field_ops::add_assign(&mut numerator, &t);
                    ...
                    field_ops::add_assign(&mut denom, &t);
                    let mut t = state_permutation_argument_linearization_challenges[1];
                    field_ops::mul_assign(&mut t, &*(memory.get_unchecked(33usize)));
                    field_ops::add_assign(&mut denom, &t);
                    let mut t = state_permutation_argument_linearization_challenges[2];
                    field_ops::mul_assign(&mut t, &*(memory.get_unchecked(34usize)));
                    field_ops::add_assign(&mut denom, &t);
        ...
        }
        {
            ...
            let contribution = {
                let individual_term = {
                    ...
                    field_ops::mul_assign(&mut t, &*(stage_2.get_unchecked(35usize)));
                    field_ops::sub_assign(&mut individual_term, &t);
                    individual_term
                };
                individual_term
        ...
        }
        {
            ...
            let contribution = {
                let individual_term = {
                    ...
                    field_ops::sub_assign(&mut individual_term, &*(stage_2.get_unchecked(24usize)));
                    individual_term
                };
                individual_term
            };
