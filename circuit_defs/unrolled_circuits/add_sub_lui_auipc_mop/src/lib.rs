...
use crate::cs::gkr_circuits::add_sub_family::*;
...
pub struct AddSubLuiAuipcMopCircuit;

impl<F: PrimeField> circuit_common::RiscVCycleCircuit<F, false> for AddSubLuiAuipcMopCircuit {
...
mod test {
    ...
    fn generate() {
        skip_if_ci!();
        circuit_common::generate_default_risc_v_non_mem_cycles_artifacts::<AddSubLuiAuipcMopCircuit>(
            true,
        );
    }
}
