...
unsafe fn evaluate_every_row_except_last(
    ...
    let every_row_except_last_contribution = {
        ...
        }
        {
            ...
            let contribution = {
                let individual_term = {
                    ...
                    individual_term.add_assign_base(&Mersenne31Field(2147450879u32));
                    individual_term
                };
                individual_term
            };
                ...
                let individual_term = {
                    let src0 = {
                        let individual_term = {
                            ...
                            {
                                let mut a = *(witness.get_unchecked(22usize));
                                a.mul_assign_by_base(&Mersenne31Field(2147483639u32));
                                individual_term.add_assign(&a);
                            }
        ...
        }
        {
            ...
            let contribution = {
                let individual_term = {
                    ...
                    let mut denom = lookup_argument_linearization_challenges[2];
                    let table_id = Mersenne31Field(17u32);
                    denom.mul_assign_by_base(&table_id);
                    let mut t = lookup_argument_linearization_challenges[1];
                    t.mul_assign_by_base(&src2);
                    denom.add_assign(&t);
        ...
        }
        {
            ...
            let contribution = {
                let individual_term = {
                    ...
                    numerator.add_assign(&write_timestamp_contribution);
                    denom.add_assign(&read_timestamp_contribution);
                    let accumulator = *(stage_2.get_unchecked(22usize));
                    let previous = *(stage_2.get_unchecked(21usize));
                    let mut individual_term = accumulator;
                    individual_term.mul_assign(&denom);
                    let mut t = previous;
        ...
        }
        {
            ...
            let contribution = {
                let individual_term = {
                    ...
                    let previous = *(stage_2.get_unchecked(22usize));
                    let mut individual_term = accumulator;
                    individual_term.mul_assign(&denom);
                    let mut t = previous;
                    t.mul_assign(&numerator);
        ...
        }
        {
            ...
            let contribution = {
                let individual_term = {
                    let mut individual_term = *(stage_2_next_row.get_unchecked(26usize));
                    let mut t = *(stage_2.get_unchecked(26usize));
                    t.mul_assign(&*(stage_2.get_unchecked(25usize)));
                    individual_term.sub_assign(&t);
                    individual_term
                };
                individual_term
        ...
        }
        {
            ...
            let contribution = {
                let individual_term = {
                    ...
                    individual_term.sub_assign(&*(stage_2.get_unchecked(16usize)));
                    individual_term
                };
                individual_term
            };
