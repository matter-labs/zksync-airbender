...
use crate::cs::gkr_circuits::jump_branch_slt_family::*;
...
impl<F: PrimeField> circuit_common::RiscVCycleCircuit<F, false> for JumpBranchSltCircuit {
...
mod test {
    ...
    fn generate() {
        skip_if_ci!();
        circuit_common::generate_default_risc_v_non_mem_cycles_artifacts::<JumpBranchSltCircuit>(
            true,
        );
    }
}
