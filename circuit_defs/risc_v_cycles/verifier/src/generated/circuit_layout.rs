const COMPILED_WITNESS_LAYOUT: CompiledWitnessSubtree<Mersenne31Field> = CompiledWitnessSubtree {
    ...
    width_3_lookups: &[
        ...
        VerifierCompiledLookupSetDescription {
            ...
            table_index: TableIndex::Variable(ColumnAddress::WitnessSubtree(93usize)),
        },
        VerifierCompiledLookupSetDescription {
            input_columns: [
            ...
            table_index: TableIndex::Variable(ColumnAddress::WitnessSubtree(97usize)),
        },
        VerifierCompiledLookupSetDescription {
            input_columns: [
            ...
            table_index: TableIndex::Variable(ColumnAddress::WitnessSubtree(101usize)),
        },
        VerifierCompiledLookupSetDescription {
            input_columns: [
            ...
            table_index: TableIndex::Variable(ColumnAddress::WitnessSubtree(105usize)),
        },
        VerifierCompiledLookupSetDescription {
            input_columns: [
...
pub const VERIFIER_COMPILED_LAYOUT: VerifierCompiledCircuitArtifact<'static, Mersenne31Field> =
    VerifierCompiledCircuitArtifact {
        ...
        lazy_init_address_aux_vars: Some(ShuffleRamAuxComparisonSet {
            ...
            intermediate_borrow: ColumnAddress::WitnessSubtree(69usize),
            final_borrow: ColumnAddress::WitnessSubtree(70usize),
        }),
