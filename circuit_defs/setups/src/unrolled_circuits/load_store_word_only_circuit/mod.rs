...
pub fn load_store_word_only_circuit_setup<A: GoodAllocator + 'static, B: GoodAllocator>(
    binary_image: &[u32],
    bytecode: &[u32],
    worker: &Worker,
    ...
    UnrolledCircuitPrecomputations {
        family_idx: ::load_store_word_only::FAMILY_IDX,
        trace_len: ::load_store_word_only::DOMAIN_SIZE,
        lde_factor: ::load_store_word_only::LDE_FACTOR,
        tree_cap_size: ::load_store_word_only::TREE_CAP_SIZE,
