...
use prover::risc_v_simulator::cycle::{IWithoutByteAccessIsaConfig, MachineConfig};
use prover::tracers::oracles::main_risc_v_circuit::MainRiscVOracle;
use prover::*;

pub const DOMAIN_SIZE: usize = 1 << 25;
...
pub const ALLOWED_DELEGATION_CSRS: &[u32] =
    prover::risc_v_simulator::cycle::IWithoutByteAccessIsaConfig::ALLOWED_DELEGATION_CSRS;
...
pub fn witness_eval_fn_for_gpu_tracer<'a, 'b>(
    proxy: &'_ mut SimpleWitnessProxy<
        'a,
        MainRiscVOracle<'b, IWithoutByteAccessIsaConfig, impl GoodAllocator>,
    >,
) {
    ...
    let fn_ptr = sealed::evaluate_witness_fn::<
        ...
        SimpleWitnessProxy<'a, MainRiscVOracle<'b, IWithoutByteAccessIsaConfig, _>>,
    >;
    (fn_ptr)(proxy);
}
