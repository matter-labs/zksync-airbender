...
EXTERN __launch_bounds__(128, 8) __global__ void ab_gkr_main_round2_flat_constant_compact_unified_compact_e4_kernel(
    const __grid_constant__ flat_round2_unified_desc_compact desc, const unsigned fold_stride, const unsigned next_layer_size, const e4 *eq_high_groups,
    const e4 *eq_low_buffer, const __grid_constant__ gkr_eq_layout_compact eq_layout, e4 *contributions, const unsigned acc_size) {
