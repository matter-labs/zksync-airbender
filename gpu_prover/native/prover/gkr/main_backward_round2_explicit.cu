...
EXTERN __global__ void ab_gkr_main_round2_batched_explicit_e4_kernel(const __grid_constant__ gkr_main_round2_batch<e4> batch, const unsigned acc_size) {
  gkr_main_round2_batched<e4, true>(batch, acc_size);
}
