use super::super::super::{GpuBaseFieldSourceKind, GpuGKRStorage};
...
pub(in crate::prover::gkr) fn build_flat_round1_unified_desc<E: Field>(
...
pub(in crate::prover::gkr) fn build_flat_round2_unified_desc<E: Field>(
