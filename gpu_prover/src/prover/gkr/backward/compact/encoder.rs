...
/// scratch.
pub(in crate::prover::gkr::backward) fn build_round0_batch_compact<B, E: Field>(
...
pub(in crate::prover::gkr::backward) fn build_round1_batch_compact<B, E: Field>(
    blueprints: &[DimensionReducingKernelBlueprint<E>],
    storage: &GpuGKRStorage<B, E>,
...
pub(in crate::prover::gkr::backward) fn build_continuation_batch_compact<B, E: Field>(
    blueprints: &[DimensionReducingKernelBlueprint<E>],
    storage: &GpuGKRStorage<B, E>,
) -> GpuGKRDimensionReducingContinuationBatchCompact<E> {
    check_record_count(blueprints.len());
