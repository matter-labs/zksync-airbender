...
use crate::prover::gkr::GpuSumcheckRound0ScheduledLaunchDescriptors;
...
pub(crate) fn launch_pairwise_round0<E: GpuDimensionReducingKernelSet>(
...
pub(crate) fn launch_lookup_round0<E: GpuDimensionReducingKernelSet>(
    descriptors: &GpuSumcheckRound0ScheduledLaunchDescriptors<impl Sized, E>,
    batch_challenges: *const E,
    contributions: *mut E,
    acc_size: usize,
...
pub(crate) fn launch_pairwise_continuation<E: GpuDimensionReducingKernelSet>(
...
pub(crate) fn launch_lookup_continuation<E: GpuDimensionReducingKernelSet>(
    descriptors: *const GpuExtensionFieldPolyContinuingLaunchDescriptor<E>,
    folding_challenge: *const E,
    batch_challenges: *const E,
    explicit_form: bool,
