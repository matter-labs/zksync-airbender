...
pub(crate) type SortKeysFunction<T> = unsafe extern "C" fn(
    *mut u8,
    &mut usize,
    *const T,
    *mut T,
...
pub(crate) trait SortKeys: Sized {
...
pub(crate) fn get_sort_keys_temp_storage_bytes<T: SortKeys>(
    descending: bool,
    num_items: u32,
    begin_bit: i32,
    end_bit: i32,
...
pub(crate) fn sort_keys<T: SortKeys>(
    descending: bool,
    d_temp_storage: &mut DeviceSlice<u8>,
