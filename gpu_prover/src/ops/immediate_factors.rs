...
pub const IMMEDIATE_FACTOR_ABSENT: u8 = 0xff;
pub const IMMEDIATE_FACTOR_ADDITIVE_PART_IDX: u8 =
    NUM_PERMUTATION_ARGUMENT_LINEARIZATION_CHALLENGES as u8;

/// CUDA mirror: `immediate_factor_recipe_header`.
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct ImmediateFactorRecipeHeader {
...
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct ImmediateFactorMonomial {
    pub coeff: BF,
...
pub struct ImmediateFactorRecipeStructural {
    ...
    pub fn evaluate(&self, ext_challenges: &[E4]) -> E4 {
        ...
        for monomial in &self.monomials {
            ...
            if monomial.challenge_idx_0 != IMMEDIATE_FACTOR_ABSENT {
                term.mul_assign(
                    &ext_challenges[monomial.challenge_idx_0 as usize].pow(monomial.power_0 as u32),
                );
            }
            if monomial.challenge_idx_1 != IMMEDIATE_FACTOR_ABSENT {
                term.mul_assign(
                    &ext_challenges[monomial.challenge_idx_1 as usize].pow(monomial.power_1 as u32),
                );
            }
            acc.add_assign(&term);
        }
...
#[derive(Default)]
pub struct ImmediateFactorInterner {
