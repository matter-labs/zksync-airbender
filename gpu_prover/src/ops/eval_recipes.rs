...
use crate::ops::immediate_factors::{ImmediateFactorMonomial, ImmediateFactorRecipeHeader};
use crate::primitives::field::{BF, E4};
use crate::primitives::utils::{get_grid_block_dims_for_threads_count, WARP_SIZE};

pub const FLAT_RECIPE_MAX_HEADERS: usize = 2816;
pub const FLAT_RECIPE_MAX_TERMS: usize = 640;
pub const FLAT_IMMEDIATE_MAX_RECIPES: usize = 128;
pub const FLAT_IMMEDIATE_MAX_MONOMIALS: usize = 384;
...
#[repr(C)]
#[derive(Clone, Copy)]
pub struct GpuFlatRecipeEvalDesc {
