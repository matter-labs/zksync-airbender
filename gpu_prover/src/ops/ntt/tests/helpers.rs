...
#[cfg(not(no_cuda))]
pub(super) fn run_monomials_to_evals(
    log_n_range: Range<usize>,
    num_bf_cols: usize,
    mut gpu_fn: impl FnMut(
        &DeviceMatrixChunk<BF>,
...
#[cfg(not(no_cuda))]
pub(super) fn evals_to_monomials_cpu_fn(inputs: &mut [BF], twiddles: &[BF], _log_n: usize) {
    ifft_natural_to_natural::<BF, BF, BF>(inputs, BF::ONE, twiddles);
}

#[cfg(not(no_cuda))]
pub(super) fn hypercube_evals_to_monomials_cpu_fn(
    inputs: &mut [BF],
    _twiddles: &[BF],
    log_n: usize,
) {
...
#[cfg(not(no_cuda))]
pub(super) fn wrap_hypercube_evals_to_monomials_2_pass(
...
#[cfg(not(no_cuda))]
pub(super) fn wrap_hypercube_evals_to_monomials_3_pass(
    inputs: &DeviceMatrixChunk<BF>,
    outputs: &mut DeviceMatrixChunkMut<BF>,
    log_n: usize,
    transposed_monomials: bool,
...
#[cfg(not(no_cuda))]
pub(super) fn wrap_evals_to_monomials_2_pass(
    inputs: &DeviceMatrixChunk<BF>,
    outputs: &mut DeviceMatrixChunkMut<BF>,
    log_n: usize,
    transposed_monomials: bool,
...
#[cfg(not(no_cuda))]
pub(super) fn wrap_evals_to_monomials_3_pass(
    inputs: &DeviceMatrixChunk<BF>,
    outputs: &mut DeviceMatrixChunkMut<BF>,
    log_n: usize,
    transposed_monomials: bool,
...
#[cfg(not(no_cuda))]
pub(super) fn wrap_monomials_to_evals_3_pass(
    inputs: &DeviceMatrixChunk<BF>,
    outputs: &mut DeviceMatrixChunkMut<BF>,
    log_n: usize,
    coset_factor_power: usize,
