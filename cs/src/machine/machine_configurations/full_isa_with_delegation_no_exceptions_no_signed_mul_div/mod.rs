...
pub struct FullIsaMachineWithDelegationNoExceptionHandlingNoSignedMulDiv;

impl<F: PrimeField> Machine<F> for FullIsaMachineWithDelegationNoExceptionHandlingNoSignedMulDiv {
...
mod test {
    ...
    fn compile_full_machine_with_delegation_without_signed_mul_div() {
        ...
        serialize_to_file(
            &compiled,
            "full_machine_with_delegation_without_signed_mul_div_layout.json",
        );
    }
    ...
    fn full_machine_with_delegation_without_signed_mul_div_get_witness_graph() {
        ...
        serialize_to_file(
            &ssa_forms,
            "full_machine_with_delegation_without_signed_mul_div_ssa.json",
        );
    }
}
