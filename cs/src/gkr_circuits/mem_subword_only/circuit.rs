...
mod test {
    ...
    ///
    ///   cargo test -p cs generate_mem_subword_only_codegen_ir_json -- --ignored --nocapture
    #[test]
    #[ignore]
    fn generate_mem_subword_only_codegen_ir_json() {
        use ::field::baby_bear::base::BabyBearField;
        ...
        write_codegen_ir_fixture(
            &cached,
            "compiled_circuits/mem_subword_only_codegen_ir_gkr.json",
        );
        ...
        write_codegen_ir_fixture(
            &no_caches,
            "compiled_circuits/mem_subword_only_codegen_ir_no_caches_gkr.json",
        );
    }
}
