...
#[inline(always)]
pub(crate) fn sll<C: Counters, R: RAM, const USE_IMM: bool>(
    state: &mut State<C>,
    ram: &mut R,
    instr: Instruction,
...
#[inline(always)]
pub(crate) fn srl<C: Counters, R: RAM, const USE_IMM: bool>(
    state: &mut State<C>,
    ram: &mut R,
    instr: Instruction,
    tracer: &mut impl WitnessTracer,
...
#[inline(always)]
pub(crate) fn sra<C: Counters, R: RAM, const USE_IMM: bool>(
    state: &mut State<C>,
    ram: &mut R,
    instr: Instruction,
    tracer: &mut impl WitnessTracer,
