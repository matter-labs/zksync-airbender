# Cached GKR memory tuples would invert the address-space tag when activated

## Classification

- Producer-parity history: confirmed historical compiler defect; latent and fail-closed before proof-producing circuits used the path
