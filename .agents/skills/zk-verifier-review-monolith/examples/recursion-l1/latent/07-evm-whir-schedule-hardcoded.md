# Latent: EVM WHIR calldata ignored alternate round schedules

## Classification

- Exact latent cross-configuration generator defect
...
honest rejection nor a weaker-parameter acceptance is established. The defect
activates when the public generator/flattener path is used for a supported
non-default schedule or changed trace geometry.
