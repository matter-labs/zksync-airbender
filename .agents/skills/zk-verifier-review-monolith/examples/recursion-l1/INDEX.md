...
| 7 | [WHIR generator hardcoded one round schedule](implementation/07-evm-whir-schedule-hardcoded.md) | `1f8cb3c` | no alternate generated verifier existed |
...
These failures reached recursion-visible data, but the demonstrated defect was
in proof construction or replay rather than a verifier acceptance predicate.
They remain useful boundary references and are excluded from verifier-centric
blind evaluation.

| # | Example | Fix | Producer-side failure |
|---:|---|---|---|
| 8 | [Merged L1 transcript omitted terminal machine state](producer-parity/08-l1-final-state-transcript.md) | `f15c643` | prover-only future-statement framing |
| 9 | [GKR inits/teardowns product ratio was reversed](producer-parity/09-l1-it-product-orientation.md) | `f15c643` | global-accumulator proof construction |
| 11 | [Keccak recursion boundary timestamp was one cycle late](producer-parity/11-keccak-recursion-timestamp.md) | `93e124e` | replay/public-state mismatch |
