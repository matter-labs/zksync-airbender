...
- Security character: committed polynomial differed from the GKR claim polynomial; primarily honest-proof failure against the canonical handoff
...
The historical correction was in proof construction. A deployed soundness claim requires checking the verifier's evaluation-point coordinate order independently.
